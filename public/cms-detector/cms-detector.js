var e = {
	...
	DOLLY_PAN: 2,
	DOLLY_ROTATE: 3
}, n = 1e3, r = 1001, i = 1002, a = 1003, o = 1004, s = 1005, c = 1006, l = 1007, u = 1008, d = 1009, f = 1010, p = 1011, m = 1012, h = 1013, g = 1014, _ = 1015, v = 1016, y = 1017, b = 1018, x = 1020, S = 35902, C = 35899, w = 1021, T = 1022, E = 1023, D = 1026, O = 1027, k = 1028, A = 1029, j = 1030, ee = 1031, M = 1033, te = 33776, N = 33777, P = 33778, ne = 33779, re = 35840, ie = 35841, ae = 35842, oe = 35843, se = 36196, ce = 37492, F = 37496, le = 37488, ue = 37489, de = 37490, fe = 37491, pe = 37808, me = 37809, he = 37810, ge = 37811, _e = 37812, ve = 37813, ye = 37814, be = 37815, xe = 37816, Se = 37817, Ce = 37818, we = 37819, Te = 37820, Ee = 37821, De = 36492, Oe = 36494, ke = 36495, Ae = 36283, je = 36284, Me = 36285, I = 36286, Ne = 2300, Pe = 2301, Fe = 2302, L = 2303, Ie = 2400, R = 2401, z = 2402, Le = 3200, Re = "srgb", ze = "srgb-linear", Be = "linear", Ve = "srgb", He = 7680, Ue = 35044, We = 2e3;
function Ge(e) {
...
var Ot = {
	...
	*[Symbol.iterator]() {
...
}, At = /* @__PURE__ */ new W(), jt = /* @__PURE__ */ new kt(), G = class e {
	static {
	...
	scale(e, t) {
		return $e("Matrix3: .scale() is deprecated. Use .makeScale() instead."), this.premultiply(Mt.makeScale(e, t)), this;
	}
	rotate(e) {
		return $e("Matrix3: .rotate() is deprecated. Use .makeRotation() instead."), this.premultiply(Mt.makeRotation(-e)), this;
	}
	translate(e, t) {
		return $e("Matrix3: .translate() is deprecated. Use .makeTranslation() instead."), this.premultiply(Mt.makeTranslation(e, t)), this;
	}
	makeTranslation(e, t) {
...
}, Mt = /* @__PURE__ */ new G(), Nt = /* @__PURE__ */ new G().set(.4123908, .3575843, .1804808, .212639, .7151687, .0721923, .0193308, .1191948, .9505322), Pt = /* @__PURE__ */ new G().set(3.2409699, -1.5373832, -.4986108, -.9692436, 1.8759675, .0415551, .0556301, -.203977, 1.0569715);
function Ft() {
	let e = {
		enabled: !0,
		...
		convert: function(e, t, n) {
			return this.enabled === !1 || t === n || !t || !n ? e : (this.spaces[t].transfer === "srgb" && (e.r = It(e.r), e.g = It(e.g), e.b = It(e.b)), this.spaces[t].primaries !== this.spaces[n].primaries && (e.applyMatrix3(this.spaces[t].toXYZ), e.applyMatrix3(this.spaces[n].fromXYZ)), this.spaces[n].transfer === "srgb" && (e.r = Lt(e.r), e.g = Lt(e.g), e.b = Lt(e.b)), e);
		},
		...
		fromWorkingColorSpace: function(t, n) {
			return $e("ColorManagement: .fromWorkingColorSpace() has been renamed to .workingToColorSpace()."), e.workingToColorSpace(t, n);
		},
		toWorkingColorSpace: function(t, n) {
			return $e("ColorManagement: .toWorkingColorSpace() has been renamed to .colorSpaceToWorking()."), e.colorSpaceToWorking(t, n);
		}
	}, t = [
		.64,
		.33,
...
var Rt, zt = class {
	static getDataURL(e, t = "image/png") {
		...
		if (e instanceof HTMLCanvasElement) n = e;
			...
			Rt === void 0 && (Rt = qe("canvas")), Rt.width = e.width, Rt.height = e.height;
			let t = Rt.getContext("2d");
			e instanceof ImageData ? t.putImageData(e, 0, 0) : t.drawImage(e, 0, 0, e.width, e.height), n = Rt;
		}
	...
	static sRGBToLinear(e) {
		if (typeof HTMLImageElement < "u" && e instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && e instanceof ImageBitmap) {
			...
			for (let e = 0; e < i.length; e++) i[e] = It(i[e] / 255) * 255;
			return n.putImageData(r, 0, 0), t;
		} else if (e.data) {
			let t = e.data.slice(0);
			for (let e = 0; e < t.length; e++) t instanceof Uint8Array || t instanceof Uint8ClampedArray ? t[e] = Math.floor(It(t[e] / 255) * 255) : t[e] = It(t[e]);
			return {
				data: t,
				width: e.width,
				height: e.height
	...
	constructor(e = null) {
		this.isSource = !0, Object.defineProperty(this, "id", { value: Bt++ }), this.uuid = st(), this.data = e, this.dataReady = !0, this.version = 0;
	}
	getSize(e) {
		let t = this.data;
	...
	toJSON(e) {
		...
		if (r !== null) {
			...
			if (Array.isArray(r)) {
				e = [];
				for (let t = 0, n = r.length; t < n; t++) r[t].isDataTexture ? e.push(Ht(r[t].image)) : e.push(Ht(r[t]));
			} else e = Ht(r);
			n.url = e;
		}
...
function Ht(e) {
	return typeof HTMLImageElement < "u" && e instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && e instanceof ImageBitmap ? zt.getDataURL(e) : e.data ? {
...
var Kt = class e {
	...
	*[Symbol.iterator]() {
	...
	constructor(e = 1, t = 1, n = {}) {
		...
		}, n), this.isRenderTarget = !0, this.width = e, this.height = t, this.depth = n.depth, this.scissor = new Kt(0, 0, e, t), this.scissorTest = !1, this.viewport = new Kt(0, 0, e, t), this.textures = [];
		let r = new Gt({
			width: e,
			height: t,
			depth: n.depth
	...
	extractRotation(e) {
		...
		let t = this.elements, n = e.elements, r = 1 / Qt.setFromMatrixColumn(e, 0).length(), i = 1 / Qt.setFromMatrixColumn(e, 1).length(), a = 1 / Qt.setFromMatrixColumn(e, 2).length();
	...
	lookAt(e, t, n) {
		let r = this.elements;
		return an.subVectors(e, t), an.lengthSq() === 0 && (an.z = 1), an.normalize(), nn.crossVectors(n, an), nn.lengthSq() === 0 && (Math.abs(n.z) === 1 ? an.x += 1e-4 : an.z += 1e-4, an.normalize(), nn.crossVectors(n, an)), nn.normalize(), rn.crossVectors(an, nn), r[0] = nn.x, r[4] = rn.x, r[8] = an.x, r[1] = nn.y, r[5] = rn.y, r[9] = an.y, r[2] = nn.z, r[6] = rn.z, r[10] = an.z, this;
	}
	multiply(e) {
		return this.multiplyMatrices(this, e);
	}
	...
	decompose(e, t, n) {
		...
		let a = Qt.set(r[0], r[1], r[2]).length(), o = Qt.set(r[4], r[5], r[6]).length(), s = Qt.set(r[8], r[9], r[10]).length();
		i < 0 && (a = -a), $t.copy(this);
		let c = 1 / a, l = 1 / o, u = 1 / s;
		return $t.elements[0] *= c, $t.elements[1] *= c, $t.elements[2] *= c, $t.elements[4] *= l, $t.elements[5] *= l, $t.elements[6] *= l, $t.elements[8] *= u, $t.elements[9] *= u, $t.elements[10] *= u, t.setFromRotationMatrix($t), n.x = a, n.y = o, n.z = s, this;
	}
...
}, Qt = /* @__PURE__ */ new W(), $t = /* @__PURE__ */ new Zt(), en = /* @__PURE__ */ new W(0, 0, 0), tn = /* @__PURE__ */ new W(1, 1, 1), nn = /* @__PURE__ */ new W(), rn = /* @__PURE__ */ new W(), an = /* @__PURE__ */ new W(), on = /* @__PURE__ */ new Zt(), sn = /* @__PURE__ */ new kt(), cn = class e {
...
var ln = class {
...
}, un = 0, dn = /* @__PURE__ */ new W(), fn = /* @__PURE__ */ new kt(), pn = /* @__PURE__ */ new Zt(), mn = /* @__PURE__ */ new W(), hn = /* @__PURE__ */ new W(), gn = /* @__PURE__ */ new W(), _n = /* @__PURE__ */ new kt(), vn = /* @__PURE__ */ new W(1, 0, 0), yn = /* @__PURE__ */ new W(0, 1, 0), bn = /* @__PURE__ */ new W(0, 0, 1), xn = { type: "added" }, Sn = { type: "removed" }, Cn = {
	type: "childadded",
	child: null
}, wn = {
	type: "childremoved",
	child: null
}, Tn = class e extends nt {
	constructor() {
		super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: un++ }), this.uuid = st(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = e.DEFAULT_UP.clone();
		let t = new W(), n = new cn(), r = new kt(), i = new W(1, 1, 1);
		function a() {
			r.setFromEuler(n, !1);
		}
		function o() {
	...
	lookAt(e, t, n) {
		...
		let r = this.parent;
		this.updateWorldMatrix(!0, !1), hn.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? pn.lookAt(hn, mn, this.up) : pn.lookAt(mn, hn, this.up), this.quaternion.setFromRotationMatrix(pn), r && (pn.extractRotation(r.matrixWorld), fn.setFromRotationMatrix(pn), this.quaternion.premultiply(fn.invert()));
	}
	add(e) {
		...
		return e === this ? (V("Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(xn), Cn.child = e, this.dispatchEvent(Cn), Cn.child = null) : V("Object3D.add: object not an instance of THREE.Object3D.", e), this);
	}
	remove(e) {
		if (arguments.length > 1) {
		...
		return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(Sn), wn.child = e, this.dispatchEvent(wn), wn.child = null), this;
	}
	removeFromParent() {
		let e = this.parent;
	...
	attach(e) {
		return this.updateWorldMatrix(!0, !1), pn.copy(this.matrixWorld).invert(), e.parent !== null && (e.parent.updateWorldMatrix(!0, !1), pn.multiply(e.parent.matrixWorld)), e.applyMatrix4(pn), e.removeFromParent(), e.parent = this, this.children.push(e), e.updateWorldMatrix(!1, !0), e.dispatchEvent(xn), Cn.child = e, this.dispatchEvent(Cn), Cn.child = null, this;
	}
	getObjectById(e) {
	...
	getWorldQuaternion(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(hn, e, gn), e;
	}
	getWorldScale(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(hn, _n, e), e;
	}
	getWorldDirection(e) {
...
Tn.DEFAULT_UP = /* @__PURE__ */ new W(0, 1, 0), Tn.DEFAULT_MATRIX_AUTO_UPDATE = !0, Tn.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0;
var En = class extends Tn {
	constructor() {
		super(), this.isGroup = !0, this.type = "Group";
	}
}, Dn = { type: "move" }, On = class {
	constructor() {
	...
	getTargetRaySpace() {
		return this._targetRay === null && (this._targetRay = new En(), this._targetRay.matrixAutoUpdate = !1, this._targetRay.visible = !1, this._targetRay.hasLinearVelocity = !1, this._targetRay.linearVelocity = new W(), this._targetRay.hasAngularVelocity = !1, this._targetRay.angularVelocity = new W()), this._targetRay;
	}
	getGripSpace() {
		return this._grip === null && (this._grip = new En(), this._grip.matrixAutoUpdate = !1, this._grip.visible = !1, this._grip.hasLinearVelocity = !1, this._grip.linearVelocity = new W(), this._grip.hasAngularVelocity = !1, this._grip.angularVelocity = new W(), this._grip.eventsEnabled = !1), this._grip;
	}
	dispatchEvent(e) {
...
var q = class {
	...
	setHSL(e, t, n, r = K.workingColorSpace) {
		if (e = ct(e, 1), t = H(t, 0, 1), n = H(n, 0, 1), t === 0) this.r = this.g = this.b = n;
			...
			this.r = Mn(i, r, e + 1 / 3), this.g = Mn(i, r, e), this.b = Mn(i, r, e - 1 / 3);
		}
	...
	getHex(e = Re) {
		return K.workingToColorSpace(Nn.copy(this), e), Math.round(H(Nn.r * 255, 0, 255)) * 65536 + Math.round(H(Nn.g * 255, 0, 255)) * 256 + Math.round(H(Nn.b * 255, 0, 255));
	}
	getHexString(e = Re) {
		return ("000000" + this.getHex(e).toString(16)).slice(-6);
	}
	getHSL(e, t = K.workingColorSpace) {
		K.workingToColorSpace(Nn.copy(this), t);
		let n = Nn.r, r = Nn.g, i = Nn.b, a = Math.max(n, r, i), o = Math.min(n, r, i), s, c, l = (o + a) / 2;
		if (o === a) s = 0, c = 0;
		else {
			let e = a - o;
	...
	getRGB(e, t = K.workingColorSpace) {
		return K.workingToColorSpace(Nn.copy(this), t), e.r = Nn.r, e.g = Nn.g, e.b = Nn.b, e;
	}
	getStyle(e = Re) {
		K.workingToColorSpace(Nn.copy(this), e);
		let t = Nn.r, n = Nn.g, r = Nn.b;
	...
	lerpHSL(e, t) {
		this.getHSL(An), e.getHSL(jn);
		let n = dt(An.h, jn.h, t), r = dt(An.s, jn.s, t), i = dt(An.l, jn.l, t);
...
var Pn = class extends Tn {
...
}, Fn = /* @__PURE__ */ new W(), In = /* @__PURE__ */ new W(), Ln = /* @__PURE__ */ new W(), Rn = /* @__PURE__ */ new W(), zn = /* @__PURE__ */ new W(), Bn = /* @__PURE__ */ new W(), Vn = /* @__PURE__ */ new W(), Hn = /* @__PURE__ */ new W(), Un = /* @__PURE__ */ new W(), Wn = /* @__PURE__ */ new W(), Gn = /* @__PURE__ */ new Kt(), Kn = /* @__PURE__ */ new Kt(), qn = /* @__PURE__ */ new Kt(), Jn = class e {
	...
	static getBarycoord(e, t, n, r, i) {
		Fn.subVectors(r, t), In.subVectors(n, t), Ln.subVectors(e, t);
		let a = Fn.dot(Fn), o = Fn.dot(In), s = Fn.dot(Ln), c = In.dot(In), l = In.dot(Ln), u = a * c - o * o;
	...
	static getInterpolation(e, t, n, r, i, a, o, s) {
		return this.getBarycoord(e, t, n, r, Rn) === null ? (s.x = 0, s.y = 0, "z" in s && (s.z = 0), "w" in s && (s.w = 0), null) : (s.setScalar(0), s.addScaledVector(i, Rn.x), s.addScaledVector(a, Rn.y), s.addScaledVector(o, Rn.z), s);
	}
	static getInterpolatedAttribute(e, t, n, r, i, a) {
		return Gn.setScalar(0), Kn.setScalar(0), qn.setScalar(0), Gn.fromBufferAttribute(e, t), Kn.fromBufferAttribute(e, n), qn.fromBufferAttribute(e, r), a.setScalar(0), a.addScaledVector(Gn, i.x), a.addScaledVector(Kn, i.y), a.addScaledVector(qn, i.z), a;
	}
	static isFrontFacing(e, t, n, r) {
		return Fn.subVectors(n, t), In.subVectors(e, t), Fn.cross(In).dot(r) < 0;
	}
	set(e, t, n) {
	...
	getArea() {
		return Fn.subVectors(this.c, this.b), In.subVectors(this.a, this.b), Fn.cross(In).length() * .5;
	}
	getMidpoint(e) {
	...
	closestPointToPoint(e, t) {
		...
		zn.subVectors(r, n), Bn.subVectors(i, n), Hn.subVectors(e, n);
		let s = zn.dot(Hn), c = Bn.dot(Hn);
		if (s <= 0 && c <= 0) return t.copy(n);
		Un.subVectors(e, r);
		let l = zn.dot(Un), u = Bn.dot(Un);
		if (l >= 0 && u <= l) return t.copy(r);
		let d = s * u - l * c;
		if (d <= 0 && s >= 0 && l <= 0) return a = s / (s - l), t.copy(n).addScaledVector(zn, a);
		Wn.subVectors(e, i);
		let f = zn.dot(Wn), p = Bn.dot(Wn);
		if (p >= 0 && f <= p) return t.copy(i);
		let m = f * c - s * p;
		if (m <= 0 && c >= 0 && p <= 0) return o = c / (c - p), t.copy(n).addScaledVector(Bn, o);
		let h = l * p - f * u;
		if (h <= 0 && u - l >= 0 && f - p >= 0) return Vn.subVectors(i, r), o = (u - l) / (u - l + (f - p)), t.copy(r).addScaledVector(Vn, o);
		let g = 1 / (h + m + d);
		return a = m * g, o = d * g, t.copy(n).addScaledVector(zn, a).addScaledVector(Bn, o);
	}
	equals(e) {
	...
	setFromArray(e) {
		this.makeEmpty();
		for (let t = 0, n = e.length; t < n; t += 3) this.expandByPoint(Zn.fromArray(e, t));
		return this;
	}
	setFromBufferAttribute(e) {
		this.makeEmpty();
		for (let t = 0, n = e.count; t < n; t++) this.expandByPoint(Zn.fromBufferAttribute(e, t));
		return this;
	}
	setFromPoints(e) {
		this.makeEmpty();
	...
	setFromCenterAndSize(e, t) {
		let n = Zn.copy(t).multiplyScalar(.5);
	...
	expandByObject(e, t = !1) {
		...
		if (n !== void 0) {
			...
			if (t === !0 && r !== void 0 && e.isInstancedMesh !== !0) for (let t = 0, n = r.count; t < n; t++) e.isMesh === !0 ? e.getVertexPosition(t, Zn) : Zn.fromBufferAttribute(r, t), Zn.applyMatrix4(e.matrixWorld), this.expandByPoint(Zn);
	...
	intersectsTriangle(e) {
		...
		this.getCenter(ar), or.subVectors(this.max, ar), $n.subVectors(e.a, ar), er.subVectors(e.b, ar), tr.subVectors(e.c, ar), nr.subVectors(er, $n), rr.subVectors(tr, er), ir.subVectors($n, tr);
		let t = [
			0,
			-nr.z,
			nr.y,
		...
		return !lr(t, $n, er, tr, or) || (t = [
			...
			0,
			1
		], !lr(t, $n, er, tr, or)) ? !1 : (sr.crossVectors(nr, rr), t = [
			sr.x,
			sr.y,
			sr.z
		], lr(t, $n, er, tr, or));
	...
	getBoundingSphere(e) {
		return this.isEmpty() ? e.makeEmpty() : (this.getCenter(e.center), e.radius = this.getSize(Zn).length() * .5), e;
	}
	intersect(e) {
	...
	/* @__PURE__ */ new W(),
	/* @__PURE__ */ new W()
], Zn = /* @__PURE__ */ new W(), Qn = /* @__PURE__ */ new Yn(), $n = /* @__PURE__ */ new W(), er = /* @__PURE__ */ new W(), tr = /* @__PURE__ */ new W(), nr = /* @__PURE__ */ new W(), rr = /* @__PURE__ */ new W(), ir = /* @__PURE__ */ new W(), ar = /* @__PURE__ */ new W(), or = /* @__PURE__ */ new W(), sr = /* @__PURE__ */ new W(), cr = /* @__PURE__ */ new W();
function lr(e, t, n, r, i) {
	for (let a = 0, o = e.length - 3; a <= o; a += 3) {
		cr.fromArray(e, a);
		let o = i.x * Math.abs(cr.x) + i.y * Math.abs(cr.y) + i.z * Math.abs(cr.z), s = t.dot(cr), c = n.dot(cr), l = r.dot(cr);
		if (Math.max(-Math.max(s, c, l), Math.min(s, c, l)) > o) return !1;
	}
	return !0;
}
var ur = /* @__PURE__ */ new W(), dr = /* @__PURE__ */ new U(), fr = 0, pr = class extends nt {
	constructor(e, t, n = !1) {
		if (super(), Array.isArray(e)) throw TypeError("THREE.BufferAttribute: array should be a Typed Array.");
		this.isBufferAttribute = !0, Object.defineProperty(this, "id", { value: fr++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e === void 0 ? 0 : e.length / t, this.normalized = n, this.usage = Ue, this.updateRanges = [], this.gpuType = _, this.version = 0;
	}
	onUploadCallback() {}
	set needsUpdate(e) {
		e === !0 && this.version++;
	...
	setXYZW(e, t, n, r, i) {
		return e *= this.itemSize, this.normalized && (t = Dt(t, this.array), n = Dt(n, this.array), r = Dt(r, this.array), i = Dt(i, this.array)), this.array[e + 0] = t, this.array[e + 1] = n, this.array[e + 2] = r, this.array[e + 3] = i, this;
	}
	onUpload(e) {
...
}, _r = /* @__PURE__ */ new Yn(), vr = /* @__PURE__ */ new W(), yr = /* @__PURE__ */ new W(), br = class {
...
}, xr = 0, Sr = /* @__PURE__ */ new Zt(), Cr = /* @__PURE__ */ new Tn(), wr = /* @__PURE__ */ new W(), Tr = /* @__PURE__ */ new Yn(), Er = /* @__PURE__ */ new Yn(), Dr = /* @__PURE__ */ new W(), Or = class e extends nt {
	constructor() {
		super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: xr++ }), this.uuid = st(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.indirectOffset = 0, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
			start: 0,
			count: Infinity
	...
	setIndex(e) {
		return Array.isArray(e) ? this.index = new (Ge(e) ? hr : mr)(e, 1) : this.index = e, this;
	}
	setIndirect(e, t = 0) {
...
}, jr = /* @__PURE__ */ new W(), Mr = /* @__PURE__ */ new W(), Nr = /* @__PURE__ */ new W(), Pr = /* @__PURE__ */ new W(), Fr = /* @__PURE__ */ new W(), Ir = /* @__PURE__ */ new W(), Lr = /* @__PURE__ */ new W(), Rr = class {
	...
	distanceSqToSegment(e, t, n, r) {
		...
		let i = e.distanceTo(t) * .5, a = -this.direction.dot(Nr), o = Pr.dot(this.direction), s = -Pr.dot(Nr), c = Pr.lengthSq(), l = Math.abs(1 - a * a), u, d, f, p;
	...
	intersectSphere(e, t) {
		...
		let n = jr.dot(this.direction), r = jr.dot(jr) - n * n, i = e.radius * e.radius;
		if (r > i) return null;
...
}, Br = /* @__PURE__ */ new Zt(), Vr = /* @__PURE__ */ new Rr(), Hr = /* @__PURE__ */ new br(), Ur = /* @__PURE__ */ new W(), Wr = /* @__PURE__ */ new W(), Gr = /* @__PURE__ */ new W(), Kr = /* @__PURE__ */ new W(), qr = /* @__PURE__ */ new W(), Jr = /* @__PURE__ */ new W(), Yr = /* @__PURE__ */ new W(), Xr = /* @__PURE__ */ new W(), Zr = class extends Tn {
	constructor(e = new Or(), t = new zr()) {
...
function $r(e, t, n, r, i, a, o, s, c, l) {
	...
	if (u) {
		let e = new W();
		Jn.getBarycoord(Yr, Wr, Gr, Kr, e), i && (u.uv = Jn.getInterpolatedAttribute(i, s, c, l, e, new U())), a && (u.uv1 = Jn.getInterpolatedAttribute(a, s, c, l, e, new U())), o && (u.normal = Jn.getInterpolatedAttribute(o, s, c, l, e, new W()), u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
		let t = {
			a: s,
			b: c,
			c: l,
		...
		Jn.getNormal(Wr, Gr, Kr, t.normal), u.face = t, u.barycoord = e;
	}
	return u;
}
var ei = class extends Gt {
...
}, ti = /* @__PURE__ */ new W(), ni = /* @__PURE__ */ new W(), ri = /* @__PURE__ */ new G(), ii = class {
	...
	setFromCoplanarPoints(e, t, n) {
		let r = ti.subVectors(n, t).cross(ni.subVectors(e, t)).normalize();
	...
	intersectLine(e, t, n = !0) {
		let r = e.delta(ti), i = this.normal.dot(r);
	...
	applyMatrix4(e, t) {
		let n = t || ri.getNormalMatrix(e), r = this.coplanarPoint(ti).applyMatrix4(e), i = this.normal.applyMatrix3(n).normalize();
...
}, ai = /* @__PURE__ */ new br(), oi = /* @__PURE__ */ new U(.5, .5), si = /* @__PURE__ */ new W(), ci = class {
	constructor(e = new ii(), t = new ii(), n = new ii(), r = new ii(), i = new ii(), a = new ii()) {
		this.planes = [
			e,
			t,
			n,
	...
	intersectsObject(e) {
		if (e.boundingSphere !== void 0) e.boundingSphere === null && e.computeBoundingSphere(), ai.copy(e.boundingSphere).applyMatrix4(e.matrixWorld);
		else {
			let t = e.geometry;
	...
	intersectsSprite(e) {
		return ai.center.set(0, 0, 0), ai.radius = .7071067811865476 + oi.distanceTo(e.center), ai.applyMatrix4(e.matrixWorld), this.intersectsSphere(ai);
	}
	intersectsSphere(e) {
	...
	intersectsBox(e) {
		...
		for (let n = 0; n < 6; n++) {
			let r = t[n];
			if (si.x = r.normal.x > 0 ? e.max.x : e.min.x, si.y = r.normal.y > 0 ? e.max.y : e.min.y, si.z = r.normal.z > 0 ? e.max.z : e.min.z, r.distanceToPoint(si) < 0) return !1;
		}
		return !0;
	}
	containsPoint(e) {
...
}, ui = /* @__PURE__ */ new W(), di = /* @__PURE__ */ new W(), fi = /* @__PURE__ */ new Zt(), pi = /* @__PURE__ */ new Rr(), mi = /* @__PURE__ */ new br(), hi = /* @__PURE__ */ new W(), gi = /* @__PURE__ */ new W(), _i = class extends Tn {
	constructor(e = new Or(), t = new li()) {
	...
	computeLineDistances() {
		...
		if (e.index === null) {
			...
			for (let e = 1, r = t.count; e < r; e++) ui.fromBufferAttribute(t, e - 1), di.fromBufferAttribute(t, e), n[e] = n[e - 1], n[e] += ui.distanceTo(di);
	...
	raycast(e, t) {
		...
		if (n.boundingSphere === null && n.computeBoundingSphere(), mi.copy(n.boundingSphere), mi.applyMatrix4(r), mi.radius += i, e.ray.intersectsSphere(mi) === !1) return;
		fi.copy(r).invert(), pi.copy(e.ray).applyMatrix4(fi);
		...
		if (l !== null) {
			...
			for (let i = n, a = r - 1; i < a; i += c) {
				let n = l.getX(i), r = l.getX(i + 1), a = vi(this, e, pi, s, n, r, i);
				a && t.push(a);
			}
			if (this.isLineLoop) {
				let i = l.getX(r - 1), a = l.getX(n), o = vi(this, e, pi, s, i, a, r - 1);
				o && t.push(o);
			}
		} else {
			let n = Math.max(0, a.start), r = Math.min(u.count, a.start + a.count);
			for (let i = n, a = r - 1; i < a; i += c) {
				let n = vi(this, e, pi, s, i, i + 1, i);
				n && t.push(n);
			}
			if (this.isLineLoop) {
				let i = vi(this, e, pi, s, r - 1, n, r - 1);
				i && t.push(i);
			}
		}
	}
...
function vi(e, t, n, r, i, a, o) {
	...
	if (ui.fromBufferAttribute(s, i), di.fromBufferAttribute(s, a), n.distanceSqToSegment(ui, di, hi, gi) > r) return;
...
var yi = /* @__PURE__ */ new W(), bi = /* @__PURE__ */ new W(), xi = class extends _i {
	constructor(e, t) {
	...
	computeLineDistances() {
		...
		if (e.index === null) {
			...
			for (let e = 0, r = t.count; e < r; e += 2) yi.fromBufferAttribute(t, e), bi.fromBufferAttribute(t, e + 1), n[e] = e === 0 ? 0 : n[e - 1], n[e + 1] = n[e] + yi.distanceTo(bi);
			e.setAttribute("lineDistance", new gr(n, 1));
	...
	copy(e) {
		return super.copy(e), this.source = new Vt(Object.assign({}, e.image)), this.compareFunction = e.compareFunction, this;
	}
	toJSON(e) {
		let t = super.toJSON(e);
	...
	constructor(e = 1, t = 1, n = 1, r = 32, i = 1, a = !1, o = 0, s = Math.PI * 2) {
		...
		_(), a === !1 && (e > 0 && v(!0), t > 0 && v(!1)), this.setIndex(l), this.setAttribute("position", new gr(u, 3)), this.setAttribute("normal", new gr(d, 3)), this.setAttribute("uv", new gr(f, 2));
		function _() {
...
}, Oi = /* @__PURE__ */ new W(), ki = /* @__PURE__ */ new W(), Ai = /* @__PURE__ */ new W(), ji = /* @__PURE__ */ new Jn(), Mi = class extends Or {
		...
		if (super(), this.type = "EdgesGeometry", this.parameters = {
			...
			for (let e = 0; e < o; e += 3) {
				...
				if (t.fromBufferAttribute(a, s[0]), o.fromBufferAttribute(a, s[1]), f.fromBufferAttribute(a, s[2]), ji.getNormal(Ai), l[0] = `${Math.round(t.x * n)},${Math.round(t.y * n)},${Math.round(t.z * n)}`, l[1] = `${Math.round(o.x * n)},${Math.round(o.y * n)},${Math.round(o.z * n)}`, l[2] = `${Math.round(f.x * n)},${Math.round(f.y * n)},${Math.round(f.z * n)}`, !(l[0] === l[1] || l[1] === l[2] || l[2] === l[0])) for (let e = 0; e < 3; e++) {
					let t = (e + 1) % 3, n = l[e], i = l[t], a = ji[c[e]], o = ji[c[t]], f = `${n}_${i}`, p = `${i}_${n}`;
					p in u && u[p] ? (Ai.dot(u[p].normal) <= r && (d.push(a.x, a.y, a.z), d.push(o.x, o.y, o.z)), u[p] = null) : f in u || (u[f] = {
						index0: s[e],
						index1: s[t],
						normal: Ai.clone()
					});
			...
			for (let e in u) if (u[e]) {
				...
				Oi.fromBufferAttribute(a, t), ki.fromBufferAttribute(a, n), d.push(Oi.x, Oi.y, Oi.z), d.push(ki.x, ki.y, ki.z);
			}
...
function Pi(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (Ii(i)) i.isRenderTargetTexture ? (B("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
			else if (Array.isArray(i)) if (Ii(i[0])) {
				let e = [];
...
var zi = {
	...
	constructor(e) {
		super(), this.isShaderMaterial = !0, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Bi, this.fragmentShader = Vi, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
			clipCullDistance: !1,
			multiDraw: !1
...
var Yi = class {
	...
	InterpolantFactoryMethodBezier(e) {
		let t = new $i(this.times, this.values, this.getValueSize(), e);
	...
	getInterpolation() {
		switch (this.createInterpolant) {
			...
			case this.InterpolantFactoryMethodBezier: return L;
		}
	}
	getValueSize() {
	...
	validate() {
		...
		if (r !== void 0 && Ke(r)) for (let t = 0, n = r.length; t !== n; ++t) {
			let n = r[t];
			if (isNaN(n)) {
...
ea.prototype.ValueTypeName = "", ea.prototype.TimeBufferType = Float32Array, ea.prototype.ValueBufferType = Float32Array, ea.prototype.DefaultInterpolation = Pe;
var ta = class extends ea {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
ta.prototype.ValueTypeName = "bool", ta.prototype.ValueBufferType = Array, ta.prototype.DefaultInterpolation = Ne, ta.prototype.InterpolantFactoryMethodLinear = void 0, ta.prototype.InterpolantFactoryMethodSmooth = void 0;
...
aa.prototype.ValueTypeName = "quaternion", aa.prototype.InterpolantFactoryMethodSmooth = void 0;
var oa = class extends ea {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
oa.prototype.ValueTypeName = "string", oa.prototype.ValueBufferType = Array, oa.prototype.DefaultInterpolation = Ne, oa.prototype.InterpolantFactoryMethodLinear = void 0, oa.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var ca = /* @__PURE__ */ new class {
	...
	constructor(e) {
		this.manager = e === void 0 ? ca : e, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {}, typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", { detail: this }));
	}
	load() {}
	loadAsync(e, t) {
		let n = this;
...
var ua = class extends Tn {
...
}, da = /* @__PURE__ */ new Zt(), fa = /* @__PURE__ */ new W(), pa = /* @__PURE__ */ new W(), ma = class {
	constructor(e) {
		this.camera = e, this.intensity = 1, this.bias = 0, this.biasNode = null, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new U(512, 512), this.mapType = d, this.map = null, this.mapPass = null, this.matrix = new Zt(), this.autoUpdate = !0, this.needsUpdate = !1, this._frustum = new ci(), this._frameExtents = new U(1, 1), this._viewportCount = 1, this._viewports = [new Kt(0, 0, 1, 1)];
	}
	getViewportCount() {
	...
	updateMatrices(e) {
		...
		fa.setFromMatrixPosition(e.matrixWorld), t.position.copy(fa), pa.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(pa), t.updateMatrixWorld(), da.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(da, t.coordinateSystem, t.reversedDepth), t.coordinateSystem === 2001 || t.reversedDepth ? n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, 1, 0, 0, 0, 0, 1) : n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, .5, .5, 0, 0, 0, 1), n.multiply(da);
	}
	getViewport(e) {
...
}, ha = /* @__PURE__ */ new W(), ga = /* @__PURE__ */ new kt(), _a = /* @__PURE__ */ new W(), va = class extends Tn {
	constructor() {
		super(), this.isCamera = !0, this.type = "Camera", this.matrixWorldInverse = new Zt(), this.projectionMatrix = new Zt(), this.projectionMatrixInverse = new Zt(), this.coordinateSystem = We, this._reversedDepth = !1;
	}
	get reversedDepth() {
	...
	updateMatrixWorld(e) {
		super.updateMatrixWorld(e), this.matrixWorld.decompose(ha, ga, _a), _a.x === 1 && _a.y === 1 && _a.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(ha, ga, _a.set(1, 1, 1)).invert();
	}
	updateWorldMatrix(e, t, n = !1) {
		super.updateWorldMatrix(e, t, n), this.matrixWorld.decompose(ha, ga, _a), _a.x === 1 && _a.y === 1 && _a.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(ha, ga, _a.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
}, ya = /* @__PURE__ */ new W(), ba = /* @__PURE__ */ new U(), xa = /* @__PURE__ */ new U(), Sa = class extends va {
	...
	getEffectiveFOV() {
		return ot * 2 * Math.atan(Math.tan(at * .5 * this.fov) / this.zoom);
	}
	getFilmWidth() {
	...
	getViewBounds(e, t, n) {
		ya.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse), t.set(ya.x, ya.y).multiplyScalar(-e / ya.z), ya.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse), n.set(ya.x, ya.y).multiplyScalar(-e / ya.z);
	}
	getViewSize(e, t) {
		return this.getViewBounds(e, ba, xa), t.subVectors(xa, ba);
	}
	...
	constructor(e, t) {
		super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(Tn.DEFAULT_UP), this.updateMatrix(), this.target = new Tn(), this.shadow = new wa();
	}
	dispose() {
...
}, Da = -90, Oa = 1, ka = class extends Tn {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new Sa(Da, Oa, e, t);
		r.layers = this.layers, this.add(r);
		let i = new Sa(Da, Oa, e, t);
		i.layers = this.layers, this.add(i);
		let a = new Sa(Da, Oa, e, t);
		a.layers = this.layers, this.add(a);
		let o = new Sa(Da, Oa, e, t);
		o.layers = this.layers, this.add(o);
		let s = new Sa(Da, Oa, e, t);
		s.layers = this.layers, this.add(s);
		let c = new Sa(Da, Oa, e, t);
...
}, ja = "\\[\\]\\.:\\/", Ma = RegExp("[" + ja + "]", "g"), Na = "[^" + ja + "]", Pa = "[^" + ja.replace("\\.", "") + "]", Fa = /* @__PURE__ */ "((?:WC+[\\/:])*)".replace("WC", Na), Ia = /* @__PURE__ */ "(WCOD+)?".replace("WCOD", Pa), La = /* @__PURE__ */ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", Na), Ra = /* @__PURE__ */ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", Na), za = RegExp("^" + Fa + Ia + La + Ra + "$"), Ba = [
	"material",
	"materials",
	"bones",
	"map"
...
Ha.Composite = Va, Ha.prototype.BindingType = {
	Direct: 0,
	EntireArray: 1,
	ArrayElement: 2,
	HasFromToArray: 3
...
var Ua = /* @__PURE__ */ new Zt(), Wa = class {
	constructor(e, t, n = 0, r = Infinity) {
		this.ray = new Rr(e, t), this.near = n, this.far = r, this.camera = null, this.layers = new ln(), this.params = {
			Mesh: {},
			Line: { threshold: 1 },
			LOD: {},
			Points: { threshold: 1 },
	...
	intersectObject(e, t = !0, n = []) {
		return Ka(e, this, n, t), n.sort(Ga), n;
	}
	intersectObjects(e, t = !0, n = []) {
		for (let r = 0, i = e.length; r < i; r++) Ka(e[r], this, n, t);
		return n.sort(Ga), n;
	}
};
function Ga(e, t) {
...
function Ka(e, t, n, r) {
	...
	if (e.layers.test(t.layers) && e.raycast(t, n) === !1 && (i = !1), i === !0 && r === !0) {
		let r = e.children;
		for (let e = 0, i = r.length; e < i; e++) Ka(r[e], t, n, !0);
	}
}
var qa = class {
...
var J = {
	...
	points: {
		uniforms: /* @__PURE__ */ Fi([Y.points, Y.fog]),
	...
	depth: {
		uniforms: /* @__PURE__ */ Fi([Y.common, Y.displacementmap]),
	...
	sprite: {
		uniforms: /* @__PURE__ */ Fi([Y.sprite, Y.fog]),
...
$a.physical = {
	uniforms: /* @__PURE__ */ Fi([$a.standard.uniforms, {
		clearcoat: { value: 0 },
...
var eo = {
	...
	b: 0,
	g: 0
}, to = /* @__PURE__ */ new Zt(), no = /* @__PURE__ */ new G();
no.set(-1, 0, 0, 0, 1, 0, 0, 0, 1);
function ro(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new Zr(new Ei(1, 1, 1), new Hi({
			name: "BackgroundCubeMaterial",
			uniforms: Pi($a.backgroundCube.uniforms),
			vertexShader: $a.backgroundCube.vertexShader,
			fragmentShader: $a.backgroundCube.fragmentShader,
			side: 1,
			depthTest: !1,
			depthWrite: !1,
			fog: !1,
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4(to.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply(no), l.material.toneMapped = K.getTransfer(i.colorSpace) !== Ve, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new Zr(new Ni(2, 2), new Hi({
			name: "BackgroundMaterial",
			uniforms: Pi($a.background.uniforms),
			vertexShader: $a.background.vertexShader,
			fragmentShader: $a.background.fragmentShader,
			side: 0,
			depthTest: !1,
			depthWrite: !1,
			fog: !1,
	...
	function g(t, r) {
		t.getRGB(eo, Ri(e)), n.buffers.color.setClear(eo.r, eo.g, eo.b, r, a);
	}
	function _() {
...
function so(e) {
	let t = this, n = null, r = 0, i = !1, a = !1, o = new ii(), s = new G(), c = {
		value: null,
		needsUpdate: !1
	};
...
var co = 4, lo = [
	...
	.526,
	.582
], uo = 20, fo = 256, po = /* @__PURE__ */ new Ca(), mo = /* @__PURE__ */ new q(), ho = null, go = 0, _o = 0, vo = !1, yo = /* @__PURE__ */ new W(), bo = class {
	constructor(e) {
		this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
	}
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = yo } = i;
		ho = this._renderer.getRenderTarget(), go = this._renderer.getActiveCubeFace(), _o = this._renderer.getActiveMipmapLevel(), vo = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(ho, go, _o), this._renderer.xr.enabled = vo, e.scissorTest = !1, Co(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), ho = this._renderer.getRenderTarget(), go = this._renderer.getActiveCubeFace(), _o = this._renderer.getActiveMipmapLevel(), vo = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas} = xo(r)), this._blurMaterial = To(r, e, t), this._ggxMaterial = wo(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
		let t = new Zr(new Or(), e);
		this._renderer.compile(t, po);
	}
	_sceneToCubeUV(e, t, n, r, i) {
		let a = new Sa(90, 1, t, n), o = [
			1,
			-1,
			1,
			1,
		...
		c.getClearColor(mo), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Zr(new Ei(), new zr({
		...
		for (let t = 0; t < 6; t++) {
			...
			Co(r, n * l, t > 2 ? l : 0, l, l), c.setRenderTarget(r), p && c.render(d, a), c.render(e, a);
		}
		c.toneMapping = u, c.autoClear = l, e.background = m;
	}
	_textureToCubeUV(e, t) {
		let n = this._renderer, r = e.mapping === 301 || e.mapping === 302;
		r ? (this._cubemapMaterial === null && (this._cubemapMaterial = Do()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = Eo());
		let i = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
		a.material = i;
		let o = i.uniforms;
		o.envMap.value = e;
		let s = this._cubeSize;
		Co(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, po);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (0 + c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - co ? n - d + co : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, Co(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, po), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, Co(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, po);
	}
	_blur(e, t, n, r, i) {
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		l.material = c;
		let u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / (2 * uo - 1), p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : uo;
		m > uo && B(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${uo}`);
		let h = [], g = 0;
		for (let e = 0; e < uo; ++e) {
		...
		Co(t, 3 * v * (r > _ - co ? r - _ + co : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, po);
	}
};
function xo(e) {
	let t = [], n = [], r = [], i = e, a = e - co + 1 + lo.length;
	for (let o = 0; o < a; o++) {
		let a = 2 ** i;
		t.push(a);
		let s = 1 / a;
		o > e - co ? s = lo[o - e + co - 1] : o === 0 && (s = 0), n.push(s);
		...
		let h = new Or();
		h.setAttribute("position", new pr(f, 3)), h.setAttribute("uv", new pr(p, 2)), h.setAttribute("faceIndex", new pr(m, 1)), r.push(new Zr(h, null)), i > co && i--;
	}
	return {
		lodMeshes: r,
		sizeLods: t,
...
var ko = class extends Jt {
	constructor(e = 1, t = {}) {
		...
		this.texture = new Si(r), this._setTextureOptions(t), this.texture.isRenderTargetTexture = !0;
	}
	fromEquirectangularTexture(e, t) {
		...
		let a = new Zr(r, i), o = t.minFilter;
		return t.minFilter === 1008 && (t.minFilter = c), new ka(1, 10, this).update(e, a), t.minFilter = o, a.geometry.dispose(), a.material.dispose(), this;
	}
	clear(e, t = !0, n = !0, r = !0) {
	...
	function o(t) {
		if (t && t.isTexture) {
			...
			if (a || o) {
				...
				if (t.isRenderTargetTexture && t.pmremVersion !== s) return r === null && (r = new bo(e)), i = a ? r.fromEquirectangular(t, i) : r.fromCubemap(t, i), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), i.texture;
				if (i !== void 0) return i.texture;
				{
					let s = t.image;
					return a && s && s.height > 0 || o && s && c(s) ? (r === null && (r = new bo(e)), i = a ? r.fromEquirectangular(t) : r.fromCubemap(t), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), t.addEventListener("dispose", u), i.texture) : null;
				}
			}
		}
		return t;
...
function Mo(e, t, n, r) {
	...
	function l(e) {
		...
		let s = new (i.count >= 65535 ? hr : mr)(n, 1);
		s.version = o;
		let c = a.get(e);
...
function Fo(e, t, n) {
	let r = /* @__PURE__ */ new WeakMap(), i = new Kt();
	function a(a, o, s) {
		...
		if (d === void 0 || d.count !== u) {
			...
			let h = new Float32Array(p * m * 4 * u), g = new Yt(h, p, m, u);
...
function Ro(e, t, n, r, i, a) {
	...
	c.setAttribute("position", new gr([
		-1,
		3,
		0,
		-1,
	...
	let l = new Ui({
		...
		depthTest: !1,
		depthWrite: !1
	}), u = new Zr(c, l), d = new Ca(-1, 1, 1, -1, 0, 1), f = null, p = null, m = !1, h, g = null, _ = [], y = !1;
...
var zo = /* @__PURE__ */ new Gt(), Bo = /* @__PURE__ */ new Ci(1, 1), Vo = /* @__PURE__ */ new Yt(), Ho = /* @__PURE__ */ new Xt(), Uo = /* @__PURE__ */ new Si(), Wo = [], Go = [], Ko = new Float32Array(16), qo = new Float32Array(9), Jo = new Float32Array(4);
function Yo(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = Wo[i];
...
function rs(e, t) {
	...
	if (r === void 0) {
		...
		if (Xo(n, r)) return;
		Jo.set(r), e.uniformMatrix2fv(this.addr, !1, Jo), Zo(n, r);
	}
}
function is(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (Xo(n, r)) return;
		qo.set(r), e.uniformMatrix3fv(this.addr, !1, qo), Zo(n, r);
	}
}
function as(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (Xo(n, r)) return;
		Ko.set(r), e.uniformMatrix4fv(this.addr, !1, Ko), Zo(n, r);
	}
}
function os(e, t) {
	let n = this.cache;
...
function ms(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (Bo.compareFunction = n.isReversedDepthBuffer() ? 518 : 515, a = Bo) : a = zo, n.setTexture2D(t || a, i);
}
function hs(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
...
function _s(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || Vo, i);
}
function vs(e) {
	switch (e) {
		case 5126: return $o;
...
function Ps(e, t, n) {
	let r = this.cache, i = t.length, a = Qo(n, i);
	Xo(r, a) || (e.uniform1iv(this.addr, a), Zo(r, a));
	let o;
	o = this.type === e.SAMPLER_2D_SHADOW ? Bo : zo;
...
function Ls(e, t, n) {
	let r = this.cache, i = t.length, a = Qo(n, i);
	Xo(r, a) || (e.uniform1iv(this.addr, a), Zo(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || Vo, a[e]);
}
function Rs(e) {
	switch (e) {
		case 5126: return ys;
		case 35664: return bs;
		case 35665: return xs;
		case 35666: return Ss;
		case 35674: return Cs;
		case 35675: return ws;
		case 35676: return Ts;
		case 5124:
		case 35670: return Es;
		case 35667:
		case 35671: return Ds;
		case 35668:
		case 35672: return Os;
		case 35669:
		case 35673: return ks;
		case 5125: return As;
		case 36294: return js;
...
var zs = class {
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.setValue = vs(t.type);
	}
}, Bs = class {
	constructor(e, t, n) {
...
function Ws(e, t, n) {
	...
	for (Hs.lastIndex = 0;;) {
		let a = Hs.exec(r), o = Hs.lastIndex, s = a[1], c = a[2] === "]", l = a[3];
		if (c && (s |= 0), l === void 0 || l === "[" && o + 2 === i) {
			Us(n, l === void 0 ? new zs(s, e, t) : new Bs(s, e, t));
			break;
		} else {
			let e = n.map[s];
			e === void 0 && (e = new Vs(s), Us(n, e)), n = e;
		}
	}
}
var Gs = class {
...
var Xs = /* @__PURE__ */ new G();
function Zs(e) {
	K._getMatrix(Xs, K.workingColorSpace, e);
...
var uc = /^[ \t]*#include +<([\w\d./]+)>/gm;
function dc(e) {
	return e.replace(uc, pc);
}
...
function yc(e) {
	return vc[e.shadowMapType] || "SHADOWMAP_TYPE_BASIC";
}
var bc = {
...
function xc(e) {
	return e.envMap === !1 ? "ENVMAP_TYPE_CUBE" : bc[e.envMapMode] || "ENVMAP_TYPE_CUBE";
}
var Sc = { 302: "ENVMAP_MODE_REFRACTION" };
function Cc(e) {
	return e.envMap === !1 ? "ENVMAP_MODE_REFLECTION" : Sc[e.envMapMode] || "ENVMAP_MODE_REFLECTION";
}
var wc = {
...
function Tc(e) {
	return e.envMap === !1 ? "ENVMAP_BLENDING_NONE" : wc[e.combine] || "ENVMAP_BLENDING_NONE";
}
function Ec(e) {
...
function Dc(e, t, n, r) {
	let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = yc(n), l = xc(n), u = Cc(n), d = Tc(n), f = Ec(n), p = ic(n), m = ac(a), h = i.createProgram(), g, _, v = n.glslVersion ? "#version " + n.glslVersion + "\n" : "";
	n.isRawShaderMaterial ? (g = [
		...
		$s("linearToOutputTexel", n.outputColorSpace),
		rc(),
	...
	let y = v + g + o, b = v + _ + s, x = Ks(i, i.VERTEX_SHADER, y), S = Ks(i, i.FRAGMENT_SHADER, b);
	...
	function C(t) {
		if (e.debug.checkShaderErrors) {
			...
			if (i.getProgramParameter(h, i.LINK_STATUS) === !1) if (l = !1, typeof e.debug.onShaderError == "function") e.debug.onShaderError(i, h, x, S);
				...
				let e = Qs(i, x, "vertex"), n = Qs(i, S, "fragment");
		...
		i.deleteShader(x), i.deleteShader(S), w = new Gs(i, h), T = oc(i, h);
	}
	let w;
	...
	return this.isReady = function() {
		return E === !1 && (E = i.getProgramParameter(h, qs)), E;
	}, this.destroy = function() {
		r.releaseStatesOfProgram(this), i.deleteProgram(h), this.program = void 0;
	}, this.type = n.shaderType, this.name = n.shaderName, this.id = Js++, this.cacheKey = t, this.usedTimes = 1, this.program = h, this.vertexShader = x, this.fragmentShader = S, this;
}
var Oc = 0, kc = class {
	constructor() {
...
function Mc(e, t, n, r, i, a) {
	let o = new ln(), s = new kc(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
	...
	function h(i, o, l, u, h, g) {
		...
		let Pe = {
			...
			packedNormalMap: oe && i.normalMapType === 0 && jc(i.normalMap.format),
			metalnessMap: F,
			roughnessMap: le,
			anisotropy: ue,
			anisotropyMap: ge,
	...
	function b(t, n) {
		let r = u.get(n);
		return r === void 0 ? (r = new Dc(e, n, t, i), l.push(r), u.set(n, r)) : ++r.usedTimes, r;
	}
	function x(e) {
		if (--e.usedTimes === 0) {
			let t = l.indexOf(e);
...
function Ic() {
	...
	function u(e, t, a) {
		n.length > 1 && n.sort(e || Pc), r.length > 1 && r.sort(t || Fc), i.length > 1 && i.sort(t || Fc), a && (n.reverse(), r.reverse(), i.reverse());
	}
	function d() {
...
function Wc(e) {
	...
	function n(n, r = 0) {
		let i = t.get(n), a;
		return i === void 0 ? (a = new Uc(e), t.set(n, [a])) : r >= i.length ? (a = new Uc(e), i.push(a)) : a = i[r], a;
	}
	function r() {
...
var Gc = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", Kc = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", qc = [
	...
	/* @__PURE__ */ new W(0, -1, 0),
	/* @__PURE__ */ new W(0, -1, 0)
], Yc = /* @__PURE__ */ new Zt(), Xc = /* @__PURE__ */ new W(), Zc = /* @__PURE__ */ new W();
function Qc(e, t, n) {
	let r = new ci(), i = new U(), o = new U(), s = new Kt(), l = new Gi(), u = new Ki(), d = {}, f = n.maxTextureSize, p = {
		0: 1,
		1: 0,
		2: 2
	}, m = new Hi({
	...
	let y = new Or();
	y.setAttribute("position", new pr(new Float32Array([
		-1,
		-1,
		.5,
		3,
		...
		for (let u = 0, d = t.length; u < d; u++) {
			...
			if (p.camera._reversedDepth = b, p.map === null || h === !0) {
				if (p.map !== null && (p.map.depthTexture !== null && (p.map.depthTexture.dispose(), p.map.depthTexture = null), p.map.dispose()), this.type === 3) {
					...
					p.map = new Jt(i.x, i.y, {
						format: j,
						type: v,
						minFilter: c,
						magFilter: c,
						generateMipmaps: !1
					}), p.map.texture.name = d.name + ".shadowMap", p.map.depthTexture = new Ci(i.x, i.y, _), p.map.depthTexture.name = d.name + ".shadowMapDepth", p.map.depthTexture.format = D, p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = a, p.map.depthTexture.magFilter = a;
				} else d.isPointLight ? (p.map = new ko(i.x), p.map.depthTexture = new wi(i.x, g)) : (p.map = new Jt(i.x, i.y), p.map.depthTexture = new Ci(i.x, i.y, g)), p.map.depthTexture.name = d.name + ".shadowMap", p.map.depthTexture.format = D, this.type === 1 ? (p.map.depthTexture.compareFunction = b ? 518 : 515, p.map.depthTexture.minFilter = c, p.map.depthTexture.magFilter = c) : (p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = a, p.map.depthTexture.magFilter = a);
	...
	function C(n, r) {
		let a = t.update(b);
		m.defines.VSM_SAMPLES !== n.blurSamples && (m.defines.VSM_SAMPLES = n.blurSamples, h.defines.VSM_SAMPLES = n.blurSamples, m.needsUpdate = !0, h.needsUpdate = !0), n.mapPass === null && (n.mapPass = new Jt(i.x, i.y, {
			format: j,
			type: v
...
function $c(e, t) {
	function n() {
		let t = !1, n = new Kt(), r = null, i = new Kt(0, 0, 0, 0);
		return {
			setMask: function(n) {
	...
	let P = null, ne = {}, re = e.getParameter(e.SCISSOR_BOX), ie = e.getParameter(e.VIEWPORT), ae = new Kt().fromArray(re), oe = new Kt().fromArray(ie);
	function se(t, n, r, i) {
...
function el(e, t, d, f, p, m, h) {
	...
	function se() {
		let e = re;
		return e >= p.maxTextures && B("WebGLTextures: Trying to use " + e + " texture units while this GPU supports only " + p.maxTextures), re += 1, e;
	}
	function ce(e) {
		let t = [];
	...
	function ye(t, n, r) {
		...
		if (o.version !== s.__version || a === !0) {
			if (d.activeTexture(e.TEXTURE0 + r), !(typeof ImageBitmap < "u" && n.image instanceof ImageBitmap)) {
				let t = K.getPrimaries(K.workingColorSpace), r = n.colorSpace === "" ? null : K.getPrimaries(n.colorSpace), i = n.colorSpace === "" || t === r ? e.NONE : e.BROWSER_DEFAULT_WEBGL;
			...
			if (n.isDepthTexture) u = j(n.format === O, n.type), _ && (g ? d.texStorage2D(e.TEXTURE_2D, 1, u, t.width, t.height) : d.texImage2D(e.TEXTURE_2D, 0, u, t.width, t.height, 0, c, l, null));
				...
				for (let r = 0, i = h.length; r < i; r++) if (f = h[r], n.format !== 1023) if (c !== null) if (g) {
					if (v) if (n.layerUpdates.size > 0) {
						let t = Ya(f.width, f.height, n.format, n.type);
				...
				g && _ && d.texStorage2D(e.TEXTURE_2D, y, u, h[0].width, h[0].height);
				for (let t = 0, r = h.length; t < r; t++) f = h[t], n.format === 1023 ? g ? v && d.texSubImage2D(e.TEXTURE_2D, t, 0, 0, f.width, f.height, c, l, f.data) : d.texImage2D(e.TEXTURE_2D, t, u, f.width, f.height, 0, c, l, f.data) : c === null ? B("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()") : g ? v && d.compressedTexSubImage2D(e.TEXTURE_2D, t, 0, 0, f.width, f.height, c, f.data) : d.compressedTexImage2D(e.TEXTURE_2D, t, u, f.width, f.height, 0, f.data);
			}
				...
				if (_ && d.texStorage3D(e.TEXTURE_2D_ARRAY, y, u, t.width, t.height, t.depth), v) if (n.layerUpdates.size > 0) {
					let r = Ya(t.width, t.height, n.format, n.type);
					for (let i of n.layerUpdates) {
	...
	function be(t, n, r) {
		...
		if (a.version !== o.__version || i === !0) {
			...
			let t = K.getPrimaries(K.workingColorSpace), s = n.colorSpace === "" ? null : K.getPrimaries(n.colorSpace), c = n.colorSpace === "" || t === s ? e.NONE : e.BROWSER_DEFAULT_WEBGL;
			...
			if (l) {
				...
				for (let t = 0; t < 6; t++) {
					...
					for (let r = 0; r < C.length; r++) {
						let i = C[r];
						n.format === 1023 ? y ? x && d.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + t, r, 0, 0, i.width, i.height, g, _, i.data) : d.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + t, r, v, i.width, i.height, 0, g, _, i.data) : g === null ? B("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()") : y ? x && d.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + t, r, 0, 0, i.width, i.height, g, i.data) : d.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + t, r, v, i.width, i.height, 0, i.data);
					}
				}
			} else {
				if (C = n.mipmaps, y && b) {
...
var nl = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", rl = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", il = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			let t = e.cameras[0].viewport, n = new Hi({
				vertexShader: nl,
				fragmentShader: rl,
				uniforms: {
			...
			this.mesh = new Zr(new Ni(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, o = "local-floor", s = 1, c = null, l = null, u = null, f = null, p = null, m = null, h = typeof XRWebGLBinding < "u", _ = new il(), v = {}, y = t.getContextAttributes(), b = null, S = null, C = [], w = [], T = new U(), k = null, A = new Sa();
		A.viewport = new Kt();
		let j = new Sa();
		j.viewport = new Kt();
		let ee = [A, j], M = new Aa(), te = null, N = null;
		...
		this.setFramebufferScaleFactor = function(e) {
			...
			if (r = l, r !== null) {
				if (b = e.getRenderTarget(), r.addEventListener("select", P), r.addEventListener("selectstart", P), r.addEventListener("selectend", P), r.addEventListener("squeeze", P), r.addEventListener("squeezestart", P), r.addEventListener("squeezeend", P), r.addEventListener("end", ne), r.addEventListener("inputsourceschange", re), y.xrCompatible !== !0 && await t.makeXRCompatible(), k = e.getPixelRatio(), e.getSize(T), h && "createProjectionLayer" in XRWebGLBinding.prototype) {
					...
					u = this.getBinding(), f = u.createProjectionLayer(s), r.updateRenderState({ layers: [f] }), e.setPixelRatio(1), e.setSize(f.textureWidth, f.textureHeight, !1), S = new Jt(f.textureWidth, f.textureHeight, {
						format: E,
						type: d,
					...
					p = new XRWebGLLayer(r, t, n), r.updateRenderState({ baseLayer: p }), e.setPixelRatio(1), e.setSize(p.framebufferWidth, p.framebufferHeight, !1), S = new Jt(p.framebufferWidth, p.framebufferHeight, {
						format: E,
						type: d,
						colorSpace: e.outputColorSpace,
						stencilBuffer: y.stencil,
...
}, ol = /* @__PURE__ */ new Zt(), sl = /* @__PURE__ */ new G();
...
function cl(e, t) {
	...
	function r(t, n) {
		n.color.getRGB(t.fogColor.value, Ri(e)), n.isFog ? (t.fogNear.value = n.near, t.fogFar.value = n.far) : n.isFogExp2 && (t.fogDensity.value = n.density);
	}
	...
	function a(e, r) {
		...
		a && (e.envMap.value = a, e.envMapRotation.value.setFromMatrix4(ol.makeRotationFromEuler(o)).transpose(), a.isCubeTexture && a.isRenderTargetTexture === !1 && e.envMapRotation.value.premultiply(sl), e.reflectivity.value = r.reflectivity, e.ior.value = r.ior, e.refractionRatio.value = r.refractionRatio), r.lightMap && (e.lightMap.value = r.lightMap, e.lightMapIntensity.value = r.lightMapIntensity, n(r.lightMap, e.lightMapTransform)), r.aoMap && (e.aoMap.value = r.aoMap, e.aoMapIntensity.value = r.aoMapIntensity, n(r.aoMap, e.aoMapTransform));
	}
	function o(e, t) {
...
function fl() {
	return dl === null && (dl = new ei(ul, 16, 16, j, v), dl.name = "DFG_LUT", dl.minFilter = c, dl.magFilter = c, dl.wrapS = r, dl.wrapT = r, dl.generateMipmaps = !1, dl.needsUpdate = !0), dl;
}
var pl = class {
	constructor(e = {}) {
		let { canvas: t = Je(), context: n = null, depth: r = !0, stencil: i = !1, alpha: a = !1, antialias: o = !1, premultipliedAlpha: s = !0, preserveDrawingBuffer: c = !1, powerPreference: l = "default", failIfMajorPerformanceCaveat: f = !1, reversedDepthBuffer: p = !1, outputBufferType: h = d } = e;
		...
		let S = h, C = new Set([
			...
			y,
			b
		]), T = new Uint32Array(4), E = new Int32Array(4), D = new W(), O = null, k = null, j = [], te = [], N = null;
		...
		let se = 0, ce = 0, F = null, le = -1, ue = null, de = new Kt(), fe = new Kt(), pe = null, me = new q(0), he = 0, ge = t.width, _e = t.height, ve = 1, ye = null, be = null, xe = new Kt(0, 0, ge, _e), Se = new Kt(0, 0, ge, _e), Ce = !1, we = new ci(), Te = !1, Ee = !1, De = new Zt(), Oe = new W(), ke = new Kt(), Ae = {
			background: null,
			fog: null,
			environment: null,
		...
		try {
			...
			if ("setAttribute" in t && t.setAttribute("data-engine", "three.js r185"), t.addEventListener("webglcontextlost", st, !1), t.addEventListener("webglcontextrestored", H, !1), t.addEventListener("webglcontextcreationerror", ct, !1), I === null) {
				let t = "webgl2";
		...
		let Pe, Fe, L, Ie, R, z, Le, ze, Be, Ve, He, Ue, Ge, Ke, qe, Ye, Xe, Qe, $e, tt, nt, rt, it;
		function at() {
			Pe = new jo(I), Pe.init(), nt = new tl(I, Pe), Fe = new oo(I, Pe, e, nt), L = new $c(I, Pe), Fe.reversedDepthBuffer && p && L.buffers.depth.setReversed(!0), ie = I.createFramebuffer(), ae = I.createFramebuffer(), oe = I.createFramebuffer(), Ie = new Po(I), R = new Nc(), z = new el(I, Pe, L, R, Fe, nt, Ie), Le = new Ao(P), ze = new Qa(I), rt = new io(I, ze), Be = new Mo(I, ze, Ie, rt), Ve = new Io(I, Be, ze, rt, Ie), Qe = new Fo(I, Fe, z), qe = new so(R), He = new Mc(P, Le, Pe, Fe, rt, qe), Ue = new cl(P, R), Ge = new Lc(), Ke = new Wc(Pe), Xe = new ro(P, Le, L, Ve, _, s), Ye = new Qc(P, Ve, Fe), it = new ll(I, Ie, Fe, L), $e = new ao(I, Pe, Ie), tt = new No(I, Pe, Ie), Ie.programs = He.programs, P.capabilities = Fe, P.extensions = Pe, P.properties = R, P.renderLists = Ge, P.shadowMap = Ye, P.state = L, P.info = Ie;
		}
		at(), S !== 1009 && (N = new Ro(S, t.width, t.height, o, r, i));
		let ot = new al(P, I);
		this.xr = ot, this.getContext = function() {
			...
			e.isVector4 ? xe.set(e.x, e.y, e.z, e.w) : xe.set(e, t, n, r), L.viewport(de.copy(xe).multiplyScalar(ve).round());
		}, this.getScissor = function(e) {
			return e.copy(Se);
		}, this.setScissor = function(e, t, n, r) {
			e.isVector4 ? Se.set(e.x, e.y, e.z, e.w) : Se.set(e, t, n, r), L.scissor(fe.copy(Se).multiplyScalar(ve).round());
		}, this.getScissorTest = function() {
			return Ce;
		}, this.setScissorTest = function(e) {
			L.setScissorTest(Ce = e);
		...
		function st(e) {
			e.preventDefault(), Ze("WebGLRenderer: Context Lost."), ne = !0;
		}
		function H() {
			Ze("WebGLRenderer: Context Restored."), ne = !1;
			let e = Ie.autoReset, t = Ye.enabled, n = Ye.autoUpdate, r = Ye.needsUpdate, i = Ye.type;
			at(), Ie.autoReset = e, Ye.enabled = t, Ye.autoUpdate = n, Ye.needsUpdate = r, Ye.type = i;
		}
		function ct(e) {
		...
		this.renderBufferDirect = function(e, t, n, r, i, a) {
			...
			rt.setup(i, r, s, n, c);
			let h, g = $e;
			if (c !== null && (h = ze.get(c), g = tt, g.setIndex(h)), i.isMesh) r.wireframe === !0 ? (L.setLineWidth(r.wireframeLinewidth * Me()), g.setMode(I.LINES)) : g.setMode(I.TRIANGLES);
			else if (i.isLine) {
				let e = r.linewidth;
				e === void 0 && (e = 1), L.setLineWidth(e * Me()), i.isLineSegments ? g.setMode(I.LINES) : i.isLineLoop ? g.setMode(I.LINE_LOOP) : g.setMode(I.LINE_STRIP);
			...
			if (i.isBatchedMesh) if (Pe.get("WEBGL_multi_draw")) g.renderMultiDraw(i._multiDrawStarts, i._multiDrawCounts, i._multiDrawCount);
				...
				let e = i._multiDrawStarts, t = i._multiDrawCounts, n = i._multiDrawCount, a = c ? ze.get(c).bytesPerElement : 1, o = R.get(r).currentProgram.getUniforms();
		...
		_t.setAnimationLoop(mt), typeof self < "u" && _t.setContext(self), this.setAnimationLoop = function(e) {
			pt = e, ot.setAnimationLoop(e), e === null ? _t.stop() : _t.start();
		}, ot.addEventListener("sessionstart", ht), ot.addEventListener("sessionend", gt), this.render = function(e, t) {
			...
			let n = ot.enabled === !0 && ot.isPresenting === !0, r = N !== null && (F === null || n) && N.begin(P, F);
			if (e.matrixWorldAutoUpdate === !0 && e.updateMatrixWorld(), t.parent === null && t.matrixWorldAutoUpdate === !0 && t.updateMatrixWorld(), ot.enabled === !0 && ot.isPresenting === !0 && (N === null || N.isCompositing() === !1) && (ot.cameraAutoUpdate === !0 && ot.updateCamera(t), t = ot.getCamera()), e.isScene === !0 && e.onBeforeRender(P, e, t, F), k = Ke.get(e, te.length), k.init(t), k.state.textureUnits = z.getTextureUnits(), te.push(k), De.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), we.setFromProjectionMatrix(De, We, t.reversedDepth), Ee = this.localClippingEnabled, Te = qe.init(this.clippingPlanes, Ee), O = Ge.get(e, j.length), O.init(), j.push(O), ot.enabled === !0 && ot.isPresenting === !0) {
				let e = P.xr.getDepthSensingMesh();
				e !== null && vt(e, t, -Infinity, P.sortObjects);
			}
			vt(e, t, 0, P.sortObjects), O.finish(), P.sortObjects === !0 && O.sort(ye, be, t.reversedDepth), je = ot.enabled === !1 || ot.isPresenting === !1 || ot.hasDepthSensing() === !1, je && Xe.addToRenderList(O, e), this.info.render.frame++, this.info.autoReset === !0 && this.info.reset(), Te === !0 && qe.beginShadows();
			...
			if (Ye.render(i, e, t), Te === !0 && qe.endShadows(), (r && N.hasRenderPass()) === !1) {
				...
				} else r.length > 0 && bt(n, r, e, t), je && Xe.render(e), yt(O, e, t);
			}
		...
		function yt(e, t, n, r) {
			...
			k.setupLightsView(n), Te === !0 && qe.setGlobalState(P.clippingPlanes, n), r && L.viewport(de.copy(r)), i.length > 0 && xt(i, t, n), a.length > 0 && xt(a, t, n), o.length > 0 && xt(o, t, n), L.buffers.depth.setTest(!0), L.buffers.depth.setMask(!0), L.buffers.color.setMask(!0), L.setPolygonOffset(!1);
		}
		function bt(e, t, n, r) {
			...
			if (k.state.transmissionRenderTarget[r.id] === void 0) {
				...
				k.state.transmissionRenderTarget[r.id] = new Jt(1, 1, {
					generateMipmaps: !0,
					type: e ? v : d,
					minFilter: u,
			...
			P.toneMapping = 0;
			let p = r.viewport;
			if (r.viewport !== void 0 && (r.viewport = void 0), k.setupLightsView(r), Te === !0 && qe.setGlobalState(P.clippingPlanes, r), xt(e, n, r), z.updateMultisampleRenderTarget(a), z.updateRenderTargetMipmap(a), Pe.has("WEBGL_multisampled_render_to_texture") === !1) {
				let e = !1;
				for (let i = 0, a = t.length; i < a; i++) {
		...
		function Ct(e, t, n) {
			t.isScene !== !0 && (t = Ae);
			let r = R.get(e), i = k.state.lights, a = k.state.shadowsArray, o = i.state.version, s = He.getParameters(e, i.state, a, t, n, k.state.lightProbeGridArray), c = He.getProgramCacheKey(s), l = r.programs;
			...
			} else s.uniforms = He.getUniforms(e), re !== null && e.isNodeMaterial && re.build(e, n, s), e.onBeforeCompile(s, P), d = He.acquireProgram(s, c), l.set(c, d), r.uniforms = s.uniforms;
			let f = r.uniforms;
			return (!e.isShaderMaterial && !e.isRawShaderMaterial || e.clipping === !0) && (f.clippingPlanes = qe.uniform), Tt(e, s), r.needsLights = U(e), r.lightsStateVersion = o, r.needsLights && (f.ambientLightColor.value = i.state.ambient, f.lightProbe.value = i.state.probe, f.directionalLights.value = i.state.directional, f.directionalLightShadows.value = i.state.directionalShadow, f.spotLights.value = i.state.spot, f.spotLightShadows.value = i.state.spotShadow, f.rectAreaLights.value = i.state.rectArea, f.ltc_1.value = i.state.rectAreaLTC1, f.ltc_2.value = i.state.rectAreaLTC2, f.pointLights.value = i.state.point, f.pointLightShadows.value = i.state.pointShadow, f.hemisphereLights.value = i.state.hemi, f.directionalShadowMatrix.value = i.state.directionalShadowMatrix, f.spotLightMatrix.value = i.state.spotLightMatrix, f.spotLightMap.value = i.state.spotLightMap, f.pointShadowMatrix.value = i.state.pointShadowMatrix), r.lightProbeGrid = k.state.lightProbeGridArray.length > 0, r.currentProgram = d, r.uniformsList = null, d;
		}
		function wt(e) {
		...
		function Dt(e, t, n, r, i) {
			...
			let a = t.fog, o = r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial ? t.environment : null, s = F === null ? P.outputColorSpace : F.isXRRenderTarget === !0 ? F.texture.colorSpace : K.workingColorSpace, c = r.isMeshStandardMaterial || r.isMeshLambertMaterial && !r.envMap || r.isMeshPhongMaterial && !r.envMap, l = Le.get(r.envMap || o, c), u = r.vertexColors === !0 && !!n.attributes.color && n.attributes.color.itemSize === 4, d = !!n.attributes.tangent && (!!r.normalMap || r.anisotropy > 0), f = !!n.morphAttributes.position, p = !!n.morphAttributes.normal, m = !!n.morphAttributes.color, h = 0;
			...
			if (L.useProgram(x.program) && (S = !0, C = !0, w = !0), r.id !== le && (le = r.id, C = !0), v.needsLights) {
				let e = Et(k.state.lightProbeGridArray, i);
				v.lightProbeGrid !== e && (v.lightProbeGrid = e, C = !0);
			}
			if (S || ue !== e) {
				L.buffers.depth.getReversed() && e.reversedDepth !== !0 && (e._reversedDepth = !0, e.updateProjectionMatrix()), T.setValue(I, "projectionMatrix", e.projectionMatrix), T.setValue(I, "viewMatrix", e.matrixWorldInverse);
			...
			if (v.needsLights && (y.state.directionalShadowMap.length > 0 && T.setValue(I, "directionalShadowMap", y.state.directionalShadowMap, z), y.state.spotShadowMap.length > 0 && T.setValue(I, "spotShadowMap", y.state.spotShadowMap, z), y.state.pointShadowMap.length > 0 && T.setValue(I, "pointShadowMap", y.state.pointShadowMap, z)), i.isSkinnedMesh) {
				T.setOptional(I, i, "bindMatrix"), T.setOptional(I, i, "bindMatrixInverse");
				let e = i.skeleton;
				e && (e.boneTexture === null && e.computeBoneTexture(), T.setValue(I, "boneTexture", e.boneTexture, z));
			}
			i.isBatchedMesh && (T.setOptional(I, i, "batchingTexture"), T.setValue(I, "batchingTexture", i._matricesTexture, z), T.setOptional(I, i, "batchingIdTexture"), T.setValue(I, "batchingIdTexture", i._indirectTexture, z), T.setOptional(I, i, "batchingColorTexture"), i._colorsTexture !== null && T.setValue(I, "batchingColorTexture", i._colorsTexture, z));
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Qe.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(I, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = fl()), C) {
				if (T.setValue(I, "toneMappingExposure", P.toneMappingExposure), v.needsLights && Ot(E, w), a && r.fog === !0 && Ue.refreshFogUniforms(E, a), Ue.refreshMaterialUniforms(E, r, ve, _e, k.state.transmissionRenderTarget[e.id]), v.needsLights && v.lightProbeGrid) {
				...
				Gs.upload(I, wt(v), E, z);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (Gs.upload(I, wt(v), E, z), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(I, "center", i.center), T.setValue(I, "modelViewMatrix", i.modelViewMatrix), T.setValue(I, "normalMatrix", i.normalMatrix), T.setValue(I, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
		...
		this.getActiveCubeFace = function() {
			...
			if (e) {
				...
				if (o.__useDefaultFramebuffer !== void 0) {
					L.bindFramebuffer(I.FRAMEBUFFER, o.__webglFramebuffer), de.copy(e.viewport), fe.copy(e.scissor), pe = e.scissorTest, L.viewport(de), L.scissor(fe), L.setScissorTest(pe), le = -1;
					return;
				...
				e.isWebGLCubeRenderTarget ? (r = Array.isArray(c[t]) ? c[t][n] : c[t], i = !0) : r = e.samples > 0 && z.useMultisampledRTT(e) === !1 ? R.get(e).__webglMultisampledFramebuffer : Array.isArray(c) ? c[n] : c, de.copy(e.viewport), fe.copy(e.scissor), pe = e.scissorTest;
			} else de.copy(xe).multiplyScalar(ve).floor(), fe.copy(Se).multiplyScalar(ve).floor(), pe = Ce;
			if (n !== 0 && (r = ie), L.bindFramebuffer(I.FRAMEBUFFER, r) && L.drawBuffers(e, r), L.viewport(de), L.scissor(fe), L.setScissorTest(pe), i) {
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) {
				...
				try {
					...
					if (e.textures.length > 1 && I.readBuffer(I.COLOR_ATTACHMENT0 + s), !Fe.textureFormatReadable(c)) {
					...
					t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i && I.readPixels(t, n, r, i, nt.convert(c), nt.convert(l), a);
				} finally {
					let e = F === null ? null : R.get(F).__webglFramebuffer;
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
				...
				if (e.textures.length > 1 && I.readBuffer(I.COLOR_ATTACHMENT0 + s), !Fe.textureFormatReadable(l)) throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");
				...
				I.bindBuffer(I.PIXEL_PACK_BUFFER, d), I.bufferData(I.PIXEL_PACK_BUFFER, a.byteLength, I.STREAM_READ), I.readPixels(t, n, r, i, nt.convert(l), nt.convert(u), 0);
				let f = F === null ? null : R.get(F).__webglFramebuffer;
				L.bindFramebuffer(I.FRAMEBUFFER, f);
				let p = I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE, 0);
				return I.flush(), await et(I, p, 4), I.bindBuffer(I.PIXEL_PACK_BUFFER, d), I.getBufferSubData(I.PIXEL_PACK_BUFFER, 0, a), I.deleteBuffer(d), I.deleteSync(p), a;
			...
			if (e.isDepthTexture) {
				...
				L.bindFramebuffer(I.READ_FRAMEBUFFER, ae), L.bindFramebuffer(I.DRAW_FRAMEBUFFER, oe);
			...
			se = 0, ce = 0, F = null, L.reset(), rt.reset();
...
}, ml = { type: "change" }, hl = { type: "start" }, gl = { type: "end" }, _l = new Rr(), vl = new ii(), yl = Math.cos(70 * Ot.DEG2RAD), bl = new W(), xl = 2 * Math.PI, Sl = {
	NONE: -1,
	ROTATE: 0,
	DOLLY: 1,
	PAN: 2,
...
}, Cl = 1e-6, wl = class extends Ja {
	constructor(n, r = null) {
		super(n, r), this.state = Sl.NONE, this.target = new W(), this.cursor = new W(), this.minDistance = 0, this.maxDistance = Infinity, this.minZoom = 0, this.maxZoom = Infinity, this.minTargetRadius = 0, this.maxTargetRadius = Infinity, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -Infinity, this.maxAzimuthAngle = Infinity, this.enableDamping = !1, this.dampingFactor = .05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.keyRotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.zoomToCursor = !1, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = {
			LEFT: "ArrowLeft",
			UP: "ArrowUp",
			RIGHT: "ArrowRight",
			BOTTOM: "ArrowDown"
	...
	reset() {
		this.target.copy(this.target0), this.object.position.copy(this.position0), this.object.zoom = this.zoom0, this.object.updateProjectionMatrix(), this.dispatchEvent(ml), this.update(), this.state = Sl.NONE;
	}
	pan(e, t) {
	...
	update(e = null) {
		...
		bl.copy(t).sub(this.target), bl.applyQuaternion(this._quat), this._spherical.setFromVector3(bl), this.autoRotate && this.state === Sl.NONE && this._rotateLeft(this._getAutoRotationAngle(e)), this.enableDamping ? (this._spherical.theta += this._sphericalDelta.theta * this.dampingFactor, this._spherical.phi += this._sphericalDelta.phi * this.dampingFactor) : (this._spherical.theta += this._sphericalDelta.theta, this._spherical.phi += this._sphericalDelta.phi);
		...
		if (bl.setFromSpherical(this._spherical), bl.applyQuaternion(this._quatInverse), t.copy(this.target).add(bl), this.object.lookAt(this.target), this.enableDamping === !0 ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
			let e = null;
			if (this.object.isPerspectiveCamera) {
				...
				r.unproject(this.object), this.object.position.sub(r).add(t), this.object.updateMatrixWorld(), e = bl.length();
			...
			e !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position) : (_l.origin.copy(this.object.position), _l.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(_l.direction)) < yl ? this.object.lookAt(this.target) : (vl.setFromNormalAndCoplanarPoint(this.object.up, this.target), _l.intersectPlane(vl, this.target))));
		} else if (this.object.isOrthographicCamera) {
		...
		return this._scale = 1, this._performCursorZoom = !1, i || this._lastPosition.distanceToSquared(this.object.position) > Cl || 8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > Cl || this._lastTargetPosition.distanceToSquared(this.target) > Cl ? (this.dispatchEvent(ml), this._lastPosition.copy(this.object.position), this._lastQuaternion.copy(this.object.quaternion), this._lastTargetPosition.copy(this.target), !0) : !1;
	}
	_getAutoRotationAngle(e) {
		return e === null ? xl / 60 / 60 * this.autoRotateSpeed : xl / 60 * this.autoRotateSpeed * e;
	}
	_getZoomScale(e) {
		let t = Math.abs(e * .01);
	...
	_panLeft(e, t) {
		bl.setFromMatrixColumn(t, 0), bl.multiplyScalar(-e), this._panOffset.add(bl);
	}
	_panUp(e, t) {
		this.screenSpacePanning === !0 ? bl.setFromMatrixColumn(t, 1) : (bl.setFromMatrixColumn(t, 0), bl.crossVectors(this.object.up, bl)), bl.multiplyScalar(e), this._panOffset.add(bl);
	}
	_pan(e, t) {
		let n = this.domElement;
		if (this.object.isPerspectiveCamera) {
			let r = this.object.position;
			bl.copy(r).sub(this.target);
			let i = bl.length();
	...
	_handleMouseMoveRotate(e) {
		...
		this._rotateLeft(xl * this._rotateDelta.x / t.clientHeight), this._rotateUp(xl * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd), this.update();
	}
	...
	_handleKeyDown(e) {
		...
		switch (e.code) {
			case this.keys.UP:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(xl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, this.keyPanSpeed), t = !0;
				break;
			case this.keys.BOTTOM:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(-xl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, -this.keyPanSpeed), t = !0;
				break;
			case this.keys.LEFT:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(xl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(this.keyPanSpeed, 0), t = !0;
				break;
	...
	_handleTouchMoveRotate(e) {
		...
		let t = this.domElement;
		this._rotateLeft(xl * this._rotateDelta.x / t.clientHeight), this._rotateUp(xl * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd);
	}
...
function Dl(e) {
	switch (this._removePointer(e), this._pointers.length) {
		case 0:
			this.domElement.releasePointerCapture(e.pointerId), this.domElement.ownerDocument.removeEventListener("pointermove", this._onPointerMove), this.domElement.ownerDocument.removeEventListener("pointerup", this._onPointerUp), this.dispatchEvent(gl), this.state = Sl.NONE, this._cursorStyle === "grab" && (this.domElement.style.cursor = "grab");
			break;
		case 1:
...
function Ol(t) {
	...
	switch (n) {
		case e.DOLLY:
			...
			this._handleMouseDownDolly(t), this.state = Sl.DOLLY;
			break;
		case e.ROTATE:
			if (t.ctrlKey || t.metaKey || t.shiftKey) {
				if (this.enablePan === !1) return;
				this._handleMouseDownPan(t), this.state = Sl.PAN;
			} else {
				if (this.enableRotate === !1) return;
				this._handleMouseDownRotate(t), this.state = Sl.ROTATE;
			}
			break;
		case e.PAN:
			if (t.ctrlKey || t.metaKey || t.shiftKey) {
			...
			break;
		default: this.state = Sl.NONE;
	}
	this.state !== Sl.NONE && this.dispatchEvent(hl);
}
function kl(e) {
	switch (this.state) {
		case Sl.ROTATE:
...
function Al(e) {
	this.enabled === !1 || this.enableZoom === !1 || this.state !== Sl.NONE || (e.preventDefault(), this.dispatchEvent(hl), this._handleMouseWheel(this._customWheelEvent(e)), this.dispatchEvent(gl));
}
function jl(e) {
	...
	switch (this._trackPointer(e), this._pointers.length) {
		case 1:
			switch (this.touches.ONE) {
				case t.ROTATE:
					if (this.enableRotate === !1) return;
					this._handleTouchStartRotate(e), this.state = Sl.TOUCH_ROTATE;
					break;
				case t.PAN:
					if (this.enablePan === !1) return;
					this._handleTouchStartPan(e), this.state = Sl.TOUCH_PAN;
					break;
				default: this.state = Sl.NONE;
			}
			break;
		case 2:
			switch (this.touches.TWO) {
				case t.DOLLY_PAN:
					...
					this._handleTouchStartDollyPan(e), this.state = Sl.TOUCH_DOLLY_PAN;
					break;
				case t.DOLLY_ROTATE:
					if (this.enableZoom === !1 && this.enableRotate === !1) return;
					this._handleTouchStartDollyRotate(e), this.state = Sl.TOUCH_DOLLY_ROTATE;
					break;
				default: this.state = Sl.NONE;
			}
			break;
...
function Nl(e) {
	switch (this._trackPointer(e), this.state) {
		...
		case Sl.TOUCH_PAN:
			...
			break;
		case Sl.TOUCH_DOLLY_PAN:
			if (this.enableZoom === !1 && this.enablePan === !1) return;
			this._handleTouchMoveDollyPan(e), this.update();
			break;
		case Sl.TOUCH_DOLLY_ROTATE:
			if (this.enableZoom === !1 && this.enableRotate === !1) return;
...
var Ll = typeof window < "u", Rl = Ll ? window : null, zl = Ll ? document : null, Bl = {
	OBJECT: 0,
	ATTRIBUTE: 1,
	CSS: 2,
	TRANSFORM: 3,
	...
	none: 1,
	blend: 2
}, Ul = Symbol(), Wl = Symbol(), Gl = Symbol(), Kl = Symbol(), ql = Symbol(), Jl = 1e-11, Yl = 0xe8d4a51000, Xl = 1e3, Zl = [], Ql = /* @__PURE__ */ (() => {
	...
	"skewX",
	"skewY"
], eu = /* @__PURE__ */ $l.reduce((e, t) => ({
	...e,
	[t]: t + "("
}), {}), tu = () => {}, nu = (e) => e, ru = /\)\s*[-.\d]/, iu = /(^#([\da-f]{3}){1,2}$)|(^#([\da-f]{4}){1,2}$)/i, au = /rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/i, ou = /rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(-?\d+|-?\d*.\d+)\s*\)/i, su = /hsl\(\s*(-?\d+|-?\d*.\d+)\s*,\s*(-?\d+|-?\d*.\d+)%\s*,\s*(-?\d+|-?\d*.\d+)%\s*\)/i, cu = /hsla\(\s*(-?\d+|-?\d*.\d+)\s*,\s*(-?\d+|-?\d*.\d+)%\s*,\s*(-?\d+|-?\d*.\d+)%\s*,\s*(-?\d+|-?\d*.\d+)\s*\)/i, lu = /[-+]?\d*\.?\d+(?:e[-+]?\d)?/gi, uu = /^([-+]?\d*\.?\d+(?:e[-+]?\d+)?)([a-z]+|%)$/i, du = /([a-z])([A-Z])/g, fu = /(\*=|\+=|-=)/, pu = /var\(\s*(--[\w-]+)(?:\s*,\s*([^)]+))?\s*\)/, mu = {
	id: null,
	keyframes: null,
	playbackEase: null,
	playbackRate: 1,
...
Ll && (Rl.AnimeJS ||= [], Rl.AnimeJS.push(_u));
//#endregion
//#region node_modules/animejs/dist/modules/core/helpers.js
var vu = (e) => e.replace(du, "$1-$2").toLowerCase(), yu = (e, t) => e.indexOf(t) === 0, bu = Date.now, xu = Array.isArray, Su = (e) => e && e.constructor === Object, Cu = (e) => typeof e == "number" && !isNaN(e), wu = (e) => typeof e == "string", Tu = (e) => typeof e == "function", Z = (e) => e === void 0, Eu = (e) => Z(e) || e === null, Du = (e) => Ll && e instanceof SVGElement, Ou = (e) => iu.test(e), ku = (e) => yu(e, "rgb"), Au = (e) => yu(e, "hsl"), ju = (e) => Ou(e) || (ku(e) || Au(e)) && (e[e.length - 1] === ")" || !ru.test(e)), Mu = (e) => !gu.defaults.hasOwnProperty(e), Nu = [
	"opacity",
	"rotate",
	"overflow",
	"color"
], Pu = (e, t) => {
	if (Nu.includes(t)) return !1;
...
}, Fu = Math.pow, Iu = Math.sqrt, Lu = Math.sin, Ru = Math.cos, zu = Math.floor, Bu = Math.asin, Vu = Math.PI, Hu = Math.round, Uu = (e, t, n) => e < t ? t : e > n ? n : e, Wu = (e, t) => {
	if (t < 0) return e;
	if (!t) return Hu(e);
	let n = 10 ** t;
	return Hu(e * n) / n;
}, Gu = (e, t, n) => n === 1 ? t : n === 0 ? e : e + (t - e) * n, Ku = (e) => e === Infinity ? Yl : e === -Infinity ? -Yl : e, qu = (e) => e <= 1e-11 ? Jl : Ku(Wu(e, 11)), Ju = (e) => xu(e) ? [...e] : e, Yu = (e, t) => {
	let n = { ...e };
	for (let r in t) {
		let i = e[r];
		n[r] = Z(i) ? t[r] : i;
	...
	if (r) {
		...
		let c = i[t];
		if (!Z(c)) return n && (n[t] = c), c;
	}
	return t === "translate3d" ? "0px, 0px, 0px" : t === "rotate3d" ? "0, 0, 0, 0deg" : yu(t, "scale") ? "1" : yu(t, "rotate") || yu(t, "skew") ? "0deg" : "0px";
}, ed = (e) => {
	let t = "";
	...
	constructor(e) {
		this.detect = e, this.props = {};
	}
	registerProperty(e, t, n, r) {
		this.props[e] = {
			get: t,
			set: n,
			gate: r || td
	...
	constructor(e) {
		this.detect = e || null, this.targetAdapters = [], this.propertyResolvers = [];
	}
	registerTargetAdapter(e) {
		let t = new nd(e);
		return this.targetAdapters.push(t), t;
	}
	registerPropertyResolver(e) {
		this.propertyResolvers.indexOf(e) === -1 && this.propertyResolvers.push(e);
	}
}, id = [];
function ad(e) {
	let t = new rd(e);
...
function od(e, t) {
	...
	outer: for (let r = 0; r < n; r++) {
		let n = id[r];
		if (n.detect && !n.detect(e)) continue;
		let i = n.targetAdapters;
		for (let n = 0, r = i.length; n < r; n++) {
			let r = i[n];
			if (r.detect(e)) {
				let n = r.props[t];
				if (n && (!n.gate || n.gate(e))) return n;
				break outer;
			}
		}
	}
...
var sd = (e) => {
	let t = au.exec(e) || ou.exec(e), n = Z(t[4]) ? 1 : +t[4];
	return [
		+t[1],
		+t[2],
		+t[3],
...
}, ld = (e, t, n) => (n < 0 && (n += 1), n > 1 && --n, n < 1 / 6 ? e + (t - e) * 6 * n : n < 1 / 2 ? t : n < 2 / 3 ? e + (t - e) * (2 / 3 - n) * 6 : e), ud = (e) => {
	let t = su.exec(e) || cu.exec(e), n = t[1] / 360, r = t[2] / 100, i = t[3] / 100, a = Z(t[4]) ? 1 : +t[4], o, s, c;
	if (r === 0) o = s = c = i;
	else {
		let e = i < .5 ? i * (1 + r) : i + r - i * r, t = 2 * i - e;
		o = Wu(ld(t, e, n + 1 / 3) * 255, 0), s = Wu(ld(t, e, n) * 255, 0), c = Wu(ld(t, e, n - 1 / 3) * 255, 0);
	}
	return [
		o,
		s,
...
}, dd = (e) => ku(e) ? sd(e) : Ou(e) ? cd(e) : Au(e) ? ud(e) : [
	0,
	0,
	0,
	1
], fd = (e, t) => Z(e) ? t : e, pd = (e, t) => {
	let n = e.match(pu), r = t[Wl] ? t : document.documentElement, i = getComputedStyle(r)?.getPropertyValue(n[1]);
	return (!i || i.trim() === "") && n[2] && (i = n[2].trim()), i || 0;
}, md = (e, t, n, r, i, a) => {
	if (Tu(e)) {
		if (!i) {
			let i = e(t, n, r, a);
	...
	return e;
}, hd = (e, t) => e[Wl] ? e[Gl] && Pu(e, t) ? Bl.ATTRIBUTE : $l.includes(t) || Ql.get(t) ? Bl.TRANSFORM : yu(t, "--") ? Bl.CSS_VAR : t in e.style ? Bl.CSS : t in e ? Bl.OBJECT : Bl.ATTRIBUTE : Bl.OBJECT, gd = (e, t, n) => {
	let r = e.style[t];
	r && n && (n[t] = r);
	let i = r || getComputedStyle(e[ql] || e).getPropertyValue(t);
	return i === "auto" ? "0" : i;
}, _d = (e, t, n, r) => {
	let i = Z(n) ? hd(e, t) : n, a = od(e, t);
	if (a) {
		let n = a.get(e);
	...
	return i === Bl.TRANSFORM ? $u(e, t, r) : i === Bl.CSS_VAR ? gd(e, t, r).trimStart() : gd(e, t, r);
}, vd = (e, t, n) => n === "-" ? e - t : n === "+" ? e + t : e * t, yd = () => ({
	t: X.NUMBER,
	n: 0,
	u: null,
	o: null,
	...
	if (t.t = X.NUMBER, t.n = 0, t.u = null, t.o = null, t.d = null, t.s = null, !e) return t;
	let n = +e;
	if (!isNaN(n)) return t.n = n, t;
	let r = e;
	r[1] === "=" && (t.o = r[0], r = r.slice(2));
	let i = r.includes(" ") ? !1 : uu.exec(r);
	if (i) return t.t = X.UNIT, t.n = +i[1], t.u = i[2], t;
	if (t.o) return t.n = +r, t;
	if (ju(r)) return t.t = X.COLOR, t.d = dd(r), t;
	{
		let e = r.match(lu);
		return t.t = X.COMPLEX, t.d = e ? e.map(Number) : [], t.s = r.split(lu) || [], t;
	}
}, xd = (e, t) => (t.t = e._valueType, t.n = e._toNumber, t.u = e._unit, t.o = null, t.d = Ju(e._toNumbers), t.s = Ju(e._strings), t), Sd = yd(), Cd = (e, t, n) => {
	let r = e._modifier, i = e._fromNumbers, a = e._toNumbers, o = e._strings, s = o[0];
	for (let c = 0, l = a.length; c < l; c++) {
		let l = r(Wu(Gu(i[c], a[c], t), n)), u = o[c + 1];
		s += `${u ? l + u : l}`, e._numbers[c] = l;
	}
	return s;
}, wd = (e, t, n, r, i) => {
	let a = e.parent, o = e.duration, s = e.completed, c = e.iterationDuration, l = e.iterationCount, u = e._currentIteration, d = e._loopDelay, f = e._reversed, p = e._alternate, m = e._hasChildren, h = e._delay, g = e._currentTime, _ = h + c, v = t - h, y = Uu(g, -h, o), b = Uu(v, -h, o), x = v - g, S = b > 0, C = b >= o, w = o <= Jl, T = i === Vl.FORCE, E = 0, D = v, O = 0;
	if (l > 1) {
		let t = c + (C ? 0 : d), n = ~~(b / t);
		e._currentIteration = Uu(n, 0, l), C && e._currentIteration--, E = e._currentIteration % 2, D = b - n * t || 0;
	}
	let k = f ^ (p && E), A = e._ease, j = C ? k ? 0 : o : k ? c - D : D;
	A && (j = c * A(j / c) || 0);
	let ee = (a ? a.backwards : v < g) ? !k : !!k;
	if (e._currentTime = v, e._iterationTime = j, e.backwards = ee, S && !e.began ? (e.began = !0, !n && !(a && (ee || !a.began)) && e.onBegin(e)) : v <= 0 && (e.began = !1), !n && !m && S && e._currentIteration !== u && e.onLoop(e), T || i === Vl.AUTO && (t >= (a && h > 0 ? 0 : h) && t <= _ || t <= h && y > h || t >= _ && y !== o) || j >= _ && y !== o || j <= h && y > 0 && !C || t <= y && y === o && s || C && !s && w) {
		if (S && (e.computeDeltaTime(y), n || e.onBeforeUpdate(e)), !m) {
			let t = T || (ee ? x * -1 : x) >= gu.tickThreshold, i = Wu(e._offset + (a ? a._offset : 0) + h + j, 12), o = e._head, s, c, l, u, d = 0;
			for (; o;) {
				let e = o._composition, n = o._currentTime, a = o._changeDuration, f = o._absoluteStartTime + o._changeDuration, p = o._nextRep, m = o._prevRep, h = e !== Hl.none, g = m ? m._absoluteStartTime + m._changeDuration : 0, _ = m && m.parent !== o.parent, v = !p || p._isOverridden ? f : p.parent === o.parent ? f + p._delay : p._absoluteStartTime < p._absoluteUpdateStartTime ? p._absoluteStartTime : p._absoluteUpdateStartTime;
				if ((t || (n !== a || i <= v || m && !_ && (!p || p.parent !== o.parent)) && (n !== 0 || i >= o._absoluteStartTime || _ && !o._hasFromValue && !m._isOverridden && i >= g || p && !p._isOverridden && p.parent === o.parent && p._currentTime !== 0 && j < p._startTime)) && (!m || _ || j >= o._startTime) && (!h || !o._isOverridden && (!o._isOverlapped || i <= f) && (!p || p._isOverridden || i <= v) && (!m || m._isOverridden || (_ ? i >= o._absoluteStartTime || !o._hasFromValue && i >= g : i >= g + o._delay)))) {
					let t = o._currentTime = Uu(j - o._startTime, 0, a), n = o._ease(t / o._updateDuration), i = o._modifier, f = o._valueType, p = o._tweenType, m = p === Bl.OBJECT, g = f === X.NUMBER, _ = g && m || n === 0 || n === 1 ? -1 : gu.precision, v, y;
					if (g) v = y = i(Wu(Gu(o._fromNumber, o._toNumber, n), _));
					else if (f === X.UNIT) y = i(Wu(Gu(o._fromNumber, o._toNumber, n), _)), v = `${y}${o._unit}`;
					else if (f === X.COLOR) {
						let e = o._numbers, t = o._fromNumbers, a = o._toNumbers, s = 1 - n, c = t[0], l = t[1], u = t[2], d = a[0], f = a[1], p = a[2];
						e[0] = i(Math.sqrt(c * c * s + d * d * n)), e[1] = i(Math.sqrt(l * l * s + f * f * n)), e[2] = i(Math.sqrt(u * u * s + p * p * n)), e[3] = i(Gu(t[3], a[3], n)), (!o._setter || r) && (v = `rgba(${Wu(e[0], 0)},${Wu(e[1], 0)},${Wu(e[2], 0)},${e[3]})`);
					} else f === X.COMPLEX && (v = Cd(o, n, _));
					if (h && (o._number = y), !r && e !== Hl.blend) {
						let e = o.property;
						s = o.target, o._setter ? o._setter(s, y, o) : m ? s[e] = v : p === Bl.ATTRIBUTE ? s.setAttribute(e, v) : (c = s.style, p === Bl.TRANSFORM ? (s !== l && (l = s, u = s[Kl]), u[e] = v, d = 1) : p === Bl.CSS ? c[e] = v : p === Bl.CSS_VAR && c.setProperty(e, v)), S && (O = 1);
					} else o._value = v;
				} else n && m && !_ && j < o._startTime && (o._currentTime = 0);
				d && o._renderTransforms && (c.transform = ed(u), d = 0), o = o._next;
			}
			!n && O && e.onRender(e);
		}
		!n && S && e.onUpdate(e);
	}
	return a && w ? !n && (a.began && !ee && v > 0 && !s || ee && v <= 1e-11 && s) && (e.onComplete(e), e.completed = !ee) : S && C ? l === Infinity ? e._startTime += e.duration : e._currentIteration >= l - 1 && (e.paused = !0, !s && !m && (e.completed = !0, !n && !(a && (ee || !a.began)) && (e.onComplete(e), e._resolve(e)))) : e.completed = !1, O;
}, Td = (e, t, n, r, i) => {
	let a = e._currentIteration;
	if (wd(e, t, n, r, i), e._hasChildren) {
		let o = e, s = o.backwards, c = r ? t : o._iterationTime, l = bu(), u = 0, d = !0;
		if (!r && o._currentIteration !== a) {
			let e = o.iterationDuration;
			Xu(o, (t) => {
				if (!s) !t.completed && !t.backwards && t._currentTime < t.iterationDuration && wd(t, e, n, 1, Vl.FORCE), t.began = !1, t.completed = !1;
				else {
		...
		Xu(o, (e) => {
			let t = Wu((c - e._offset) * e._speed, 12);
			if (s && t > e._delay + e.duration) return;
			let a = e._fps < o._fps ? e.requestTick(l) : i;
			u += wd(e, t, n, r, a), !e.completed && d && (d = !1);
		}, s), !n && u && o.onRender(o), (d || s) && o._currentTime >= o.duration && (o.paused = !0, o.completed || (o.completed = !0, n || (o.onComplete(o), o._resolve(o))));
	}
}, Ed = {}, Dd = (e, t, n) => {
	if (n === Bl.TRANSFORM) return Ql.get(e) || e;
	if (n === Bl.CSS || n === Bl.ATTRIBUTE && Du(t) && e in t.style) {
		let t = Ed[e];
		if (t) return t;
		{
			let t = e && vu(e);
	...
	if (e._hasChildren) Xu(e, (e) => Od(e, t), !0);
	else {
		let n = e;
		n.pause(), Xu(n, (e) => {
			let r = e.property, i = e.target, a = e._tweenType, o = e._inlineValue, s = Eu(o) || o === "";
			if (e._setter) {
				if (!t && !s) {
					if (bd(o, Sd), Sd.d) {
						let t = Sd.d, n = e._numbers;
						for (let e = 0, r = t.length; e < r; e++) n[e] = t[e];
					} else e._number = Sd.n;
					e._setter(e.target, e._number, e);
				}
			} else if (a === Bl.OBJECT) !t && !s && (i[r] = o);
			else if (i[Wl]) if (a === Bl.ATTRIBUTE) t || (s ? i.removeAttribute(r) : i.setAttribute(r, o));
			else {
				let t = i.style;
				if (a === Bl.TRANSFORM) {
					let n = i[Kl];
					s ? delete n[r] : n[r] = o, e._renderTransforms && (Object.keys(n).length ? t.transform = ed(n) : t.removeProperty("transform"));
				} else s ? t.removeProperty(vu(r)) : t[r] = o;
			}
			i[Wl] && n._tail === e && n.targets.forEach((e) => {
	...
	constructor(e = 0) {
		this.deltaTime = 0, this._currentTime = e, this._lastTickTime = e, this._startTime = e, this._lastTime = e, this._frameDuration = Xl / 240, this._fps = 240, this._speed = 1, this._hasChildren = !1, this._head = null, this._tail = null;
	}
	get fps() {
		return this._fps;
	}
	set fps(e) {
		let t = +e, n = t < 1e-11 ? Jl : t, r = Xl / n;
		n > mu.frameRate && (mu.frameRate = n), this._fps = n, this._frameDuration = r;
	}
	get speed() {
		return this._speed;
	}
	set speed(e) {
		let t = +e;
		this._speed = t < 1e-11 ? Jl : t;
	}
	requestTick(e) {
		let t = this._frameDuration, n = e - this._lastTickTime, r = t * .25;
		return n + (r < 4 ? r : 4) < t ? Vl.NONE : (this._lastTickTime = n >= t ? e - n % t : e, Vl.AUTO);
	}
	computeDeltaTime(e) {
	...
	return t || (t = {
		...
		_head: null,
		_tail: null
	}, Ad.animation = t, Ad.update = () => {
		e.forEach((e) => {
			for (let t in e) {
				let n = e[t], r = n._head;
				if (r) {
					let e = r._valueType, t = e === X.COMPLEX || e === X.COLOR ? Ju(r._fromNumbers) : null, i = r._fromNumber, a = n._tail;
					for (; a && a !== r;) {
...
}, Md = Ll ? requestAnimationFrame : setImmediate, Nd = Ll ? cancelAnimationFrame : clearImmediate, Pd = class extends kd {
	constructor(e) {
		super(e), this.useDefaultMainLoop = !0, this.pauseOnDocumentHidden = !0, this.defaults = mu, this.paused = !0, this.reqId = 0;
	}
	update() {
		let e = this._currentTime = bu();
		if (this.requestTick(e)) {
			this.computeDeltaTime(e);
			let t = this._speed, n = this._fps, r = this._head;
			for (; r;) {
				let i = r._next;
				r.paused ? (Zu(this, r), this._hasChildren = !!this._tail, r._running = !1, r.completed && !r._cancelled && r.cancel()) : Td(r, (e - r._startTime) * r._speed * t, 0, 0, r._fps < n ? r.requestTick(e) : Vl.AUTO), r = i;
			}
			Ad.update();
		}
	}
	wake() {
		return this.useDefaultMainLoop && !this.reqId && (this.requestTick(bu()), this.reqId = Md(Id)), this;
	}
	pause() {
		if (this.reqId) return this.paused = !0, Ld();
	}
	resume() {
		if (this.paused) return this.paused = !1, Xu(this, (e) => e.resetTime()), this.wake();
	}
	get speed() {
		return this._speed * (gu.timeScale === 1 ? 1 : Xl);
	}
	set speed(e) {
		let t = e * gu.timeScale;
		this._speed !== t && (this._speed = t, Xu(this, (e) => e.speed = e._speed));
	}
	get timeUnit() {
		return gu.timeScale === 1 ? "ms" : "s";
	}
	set timeUnit(e) {
		let t = .001, n = e === "s", r = n ? t : 1;
		if (gu.timeScale !== r) {
			gu.timeScale = r, gu.tickThreshold = 200 * r;
			let e = n ? t : Xl;
	...
	let e = new Pd(bu());
	return Ll && (_u.engine = e, zl.addEventListener("visibilitychange", () => {
		e.pauseOnDocumentHidden && (zl.hidden ? e.pause() : e.resume());
	})), e;
})(), Id = () => {
	Fd._head ? (Fd.reqId = Md(Id), Fd.update()) : Fd.reqId = 0;
}, Ld = () => (Nd(Fd.reqId), Fd.reqId = 0, Fd), Rd = {
	_rep: /* @__PURE__ */ new WeakMap(),
	_add: /* @__PURE__ */ new Map()
}, zd = (e, t, n = "_rep") => {
	let r = Rd[n], i = r.get(e);
	return i || (i = {}, r.set(e, i)), i[t] ? i[t] : i[t] = {
		_head: null,
		_tail: null
	};
}, Bd = (e, t) => e._isOverridden || e._absoluteStartTime > t._absoluteStartTime, Vd = (e) => {
	e._isOverlapped = 1, e._isOverridden = 1, e._changeDuration = Jl, e._currentTime = Jl;
}, Hd = (e, t) => {
	let n = e._composition;
	if (n === Hl.replace) {
		let n = e._absoluteStartTime;
		Qu(t, e, Bd, "_prevRep", "_nextRep");
		let r = e._prevRep;
		if (r) {
			...
			if (e.parent.id !== t.id && t.iterationCount > 1 && i + (t.duration - t.iterationDuration) > n) {
				Vd(r);
				let e = r._prevRep;
				for (; e && e.parent.id === t.id;) Vd(e), e = e._prevRep;
			}
			let a = e._absoluteUpdateStartTime;
			if (i > a) {
				let e = r._startTime, t = Wu(a - (i - (e + r._updateDuration)) - e, 12);
				r._changeDuration = t, r._currentTime = t, r._isOverlapped = 1, t < 1e-11 && Vd(r);
			}
		...
		let t = zd(e.target, e.property, "_add"), n = jd(Rd._add), r = t._head;
		r || (r = { ...e }, r._composition = Hl.replace, r._updateDuration = Jl, r._startTime = 0, r._numbers = Ju(e._fromNumbers), r._number = 0, r._next = null, r._prev = null, Qu(t, r), Qu(n, r));
		let i = e._toNumber;
		if (e._fromNumber = r._fromNumber - i, e._toNumber = 0, e._numbers = Ju(e._fromNumbers), e._number = 0, r._fromNumber = i, e._toNumbers.length) {
			let t = Ju(e._toNumbers);
			t.forEach((t, n) => {
				e._fromNumbers[n] = r._fromNumbers[n] - t, e._toNumbers[n] = 0;
			}), r._fromNumbers = t;
		}
		Qu(t, e, null, "_prevAdd", "_nextAdd");
	}
	return e;
}, Ud = (e) => {
	let t = e._composition;
	if (t !== Hl.none) {
		let n = e.target, r = e.property, i = Rd._rep.get(n)[r];
		if (Zu(i, e, "_prevRep", "_nextRep"), t === Hl.blend) {
			let t = Rd._add, i = t.get(n);
			if (!i) return;
			let a = i[r], o = Ad.animation;
			Zu(a, e, "_prevAdd", "_nextAdd");
			let s = a._head;
			if (s && s === a._tail) {
				Zu(a, s, "_prevAdd", "_nextAdd"), Zu(o, s);
				let e = !0;
	...
	return Xu(t, (i) => {
		let a = i.target;
		if (e.includes(a)) {
			let e = i.property, o = i._tweenType, s = Dd(n, a, o);
			(!s || s && s === e) && (i.parent._tail === i && i._tweenType === Bl.TRANSFORM && i._prev && i._prev._tweenType === Bl.TRANSFORM && (i._prev._renderTransforms = 1), Zu(t, i), Ud(i), r = !0);
		}
	}, !0), r;
}, Gd = (e, t, n) => {
	let r = t || Fd, i;
	if (r._hasChildren) {
		let t = 0;
		Xu(r, (a) => {
			if (!a._hasChildren) if (i = Wd(e, a, n), i && !a._head) a.cancel(), Zu(r, a);
			else {
				let e = a._offset + a._delay + a.duration;
				e > t && (t = e);
			}
			a._head ? Gd(e, a, n) : a._hasChildren = !1;
		}, !0), Z(r.iterationDuration) || (r.iterationDuration = t);
	} else i = Wd(e, r, n);
	i && !r._head && (r._hasChildren = !1, r.cancel && r.cancel());
}, Kd = (e) => (e.paused = !0, e.began = !1, e.completed = !1, e), qd = (e) => e._cancelled ? (e._hasChildren ? Xu(e, qd) : Xu(e, (e) => {
	e._composition !== Hl.none && Hd(e, zd(e.target, e.property));
}), e._cancelled = 0, e) : e, Jd = 0, Yd = (e, t) => e._priority > t._priority, Xd = class extends kd {
	constructor(e = {}, t = null, n = 0) {
		...
		hu.current && hu.current.register(this);
		let b = t ? 0 : Fd._lastTickTime, x = t ? t.defaults : gu.defaults, S = Tu(i) || Z(i) ? x.delay : +i, C = Tu(a) || Z(a) ? Infinity : +a, w = fd(c, x.loop), T = fd(l, x.loopDelay), E = w === !0 || w === Infinity || w < 0 ? Infinity : w + 1, D = 0;
		t ? D = n : (Fd.reqId || Fd.requestTick(bu()), D = (Fd._lastTickTime - Fd._startTime) * gu.timeScale), this.id = Z(r) ? Jd : r, this.parent = t, this.duration = Ku((C + T) * E - T) || 1e-11, this.backwards = !1, this.paused = !0, this.began = !1, this.completed = !1, this.onBegin = _ || x.onBegin, this.onBeforeUpdate = v || x.onBeforeUpdate, this.onUpdate = y || x.onUpdate, this.onLoop = h || x.onLoop, this.onPause = g || x.onPause, this.onComplete = m || x.onComplete, this.iterationDuration = C, this.iterationCount = E, this._autoplay = t ? !1 : fd(u, x.autoplay), this._offset = D, this._delay = S, this._loopDelay = T, this._iterationTime = 0, this._currentIteration = 0, this._resolve = tu, this._running = !1, this._reversed = +fd(o, x.reversed), this._reverse = this._reversed, this._cancelled = 0, this._alternate = fd(s, x.alternate), this._prev = null, this._next = null, this._lastTickTime = b, this._startTime = b, this._lastTime = b, this._fps = fd(d, x.frameRate), this._speed = fd(f, x.playbackRate), this._priority = +fd(p, 1);
	}
	get cancelled() {
	...
	get currentTime() {
		return Uu(Wu(this._currentTime, gu.precision), -this._delay, this.duration);
	}
	set currentTime(e) {
		let t = this.paused;
	...
	get iterationCurrentTime() {
		return Uu(Wu(this._iterationTime, gu.precision), 0, this.iterationDuration);
	}
	set iterationCurrentTime(e) {
		this.currentTime = this.iterationDuration * this._currentIteration + e;
	}
	get progress() {
		return Uu(Wu(this._currentTime / this.duration, 10), 0, 1);
	}
	set progress(e) {
		this.currentTime = this.duration * e;
	}
	get iterationProgress() {
		return Uu(Wu(this._iterationTime / this.iterationDuration, 10), 0, 1);
	}
	...
	set currentIteration(e) {
		this.currentTime = this.iterationDuration * Uu(+e, 0, this.iterationCount - 1);
	}
	get reversed() {
	...
	reset(e = !1) {
		return qd(this), this._reversed && !this._reverse && (this.reversed = !1), this._iterationTime = this.iterationDuration, Td(this, 0, 1, ~~e, Vl.FORCE), Kd(this), this._hasChildren && Xu(this, Kd), this;
	}
	init(e = !1) {
		this.fps = this._fps, this.speed = this._speed, !e && this._hasChildren && Td(this, this.duration, 1, ~~e, Vl.FORCE), this.reset(e);
		let t = this._autoplay;
		return t === !0 ? this.resume() : t && !Z(t.linked) && t.link(this), this;
	}
	resetTime() {
		let e = 1 / (this._speed * Fd._speed);
		return this._startTime = bu() - (this._currentTime + this._delay) * e, this;
	}
	pause() {
		return this.paused ? this : (this.paused = !0, this.onPause(this), this);
	}
	resume() {
		return this.paused ? (this.paused = !1, this.duration <= 1e-11 && !this._hasChildren ? Td(this, Jl, 0, 0, Vl.FORCE) : (this._running ||= (Qu(Fd, this, Yd), Fd._hasChildren = !0, !0), this.resetTime(), this._startTime -= 12, Fd.wake()), this) : this;
	}
	restart() {
		return this.reset().resume();
	}
	seek(e, t = 0, n = 0) {
		qd(this), this.completed = !1;
		let r = this.paused;
		return this.paused = !0, Td(this, e + this._delay, ~~t, ~~n, Vl.AUTO), r ? this : this.resume();
	}
	alternate() {
		let e = this._reversed, t = this.iterationCount, n = this.iterationDuration, r = t === Infinity ? zu(Yl / n) : t;
	...
	cancel() {
		return this._hasChildren ? Xu(this, (e) => e.cancel(), !0) : Xu(this, Ud), this._cancelled = 1, this.pause();
	}
	stretch(e) {
		let t = this.duration, n = qu(e);
		if (t === n) return this;
		let r = e / t, i = e <= Jl;
		return this.duration = i ? Jl : n, this.iterationDuration = i ? Jl : qu(this.iterationDuration * r), this._offset *= r, this._delay *= r, this._loopDelay *= r, this;
	}
	revert() {
		Td(this, 0, 1, 0, Vl.AUTO);
	...
	then(e = tu) {
		let t = this.then, n = () => {
			this.then = null, e(this), this.then = t, this._resolve = tu;
		};
...
function Zd(e) {
	let t = wu(e) ? hu.root.querySelectorAll(e) : e;
	if (t instanceof NodeList || t instanceof HTMLCollection) return t;
}
function Qd(e) {
	if (Eu(e)) return [];
	if (!Ll) return xu(e) && e.flat(Infinity) || [e];
	if (xu(e)) {
...
function $d(e) {
	let t = Qd(e), n = t.length;
	for (let e = 0; e < n; e++) {
		let n = t[e];
		if (!n[Ul]) {
			n[Ul] = !0;
			let e = Du(n);
			(n.nodeType || e) && (n[Wl] = !0, n[Gl] = e, n[Kl] = {});
		}
	}
	return t;
}
...
var ef = {
	...
	let i = t.u, a = t.n;
	if (t.t === X.UNIT && i === n) return t;
	let o = a + i + n, s = tf[o];
	if (!Z(s) && !r) t.n = s;
	else {
		let r;
		if (i in ef) r = a * ef[i] / ef[n];
		else {
			let t = e.cloneNode(), o = e.parentNode, s = o && o !== zl ? o : zl.body;
			s.appendChild(t);
			let c = t.style;
			c.width = 100 + i;
	...
	return t.t, X.UNIT, t.u = n, t;
}, rf = (e) => e, af = (e = 1.68) => (t) => Fu(t, +e), of = {
	in: (e) => (t) => e(t),
	out: (e) => (t) => 1 - e(1 - t),
	...
	Sine: (e) => 1 - Ru(e * sf),
	Circ: (e) => 1 - Iu(1 - e * e),
	Expo: (e) => e ? Fu(2, 10 * e - 10) : 0,
	Bounce: (e) => {
		let t, n = 4;
		for (; e < ((t = Fu(2, --n)) - 1) / 11;);
		return 1 / Fu(4, 3 - n) - 7.5625 * Fu((t * 3 - 2) / 22 - e, 2);
	},
	Back: (e = 1.7) => (t) => (+e + 1) * t * t * t - +e * t * t,
	Elastic: (e = 1, t = .3) => {
		let n = Uu(+e, 1, 10), r = Uu(+t, Jl, 2), i = r / cf * Bu(1 / n), a = cf / r;
		return (e) => e === 0 || e === 1 ? e : -n * Fu(2, -10 * (1 - e)) * Lu((1 - e - i) * a);
	}
}, uf = /* @__PURE__ */ (() => {
	let e = {
		linear: rf,
	...
	for (let t in of) for (let n in lf) {
		let r = lf[n], i = of[t];
	...
	if (df[e]) return df[e];
	if (e.indexOf("(") <= -1) {
		let t = of[e] || e.includes("Back") || e.includes("Elastic") ? uf[e]() : uf[e];
		return t ? df[e] = t : rf;
	} else {
		let t = e.slice(0, -1).split("("), n = uf[t[0]];
		return n ? df[e] = n(...t[1].split(",")) : rf;
	}
}, pf = [
	"steps(",
	"irregular(",
	...
	if (wu(e)) {
		for (let t = 0, n = pf.length; t < n; t++) if (yu(e, pf[t])) return console.warn(`String syntax for \`ease: "${e}"\` has been removed from the core and replaced by importing and passing the easing function directly: \`ease: ${e}\``), rf;
	}
	return Tu(e) ? e : wu(e) ? ff(e) : rf;
}, Q = yd(), $ = yd(), hf = {}, gf = { func: null }, _f = { func: null }, vf = [null], yf = [null, null], bf = { to: null }, xf = 0, Sf = 0, Cf, wf, Tf = (e, t) => {
	let n = {};
	if (xu(e)) {
		let t = [].concat(...e.map((e) => Object.keys(e))).filter(Mu);
		for (let r = 0, i = t.length; r < i; r++) {
			...
			n[i] = e.map((e) => {
				...
				for (let n in e) {
					let r = e[n];
					Mu(n) ? n === i && (t.to = r) : t[n] = r;
				}
				return t;
			});
		}
	} else {
		let r = fd(t.duration, gu.defaults.duration);
		Object.keys(e).map((t) => ({
			o: parseFloat(t) / 100,
			p: e[t]
		})).sort((e, t) => e.o - t.o).forEach((e) => {
			let t = e.o, i = e.p;
			for (let e in i) if (Mu(e)) {
				let a = n[e];
				a ||= n[e] = [];
	...
	constructor(e, t, n, r, i = !1, a = 0, o) {
		super(t, n, r), this._head, this._tail, ++Sf;
		let s = $d(e), c = s.length, l = t.keyframes, u = l ? Yu(Tf(l, t), t) : t, { id: d, delay: f, duration: p, ease: m, playbackEase: h, modifier: g, composition: _, onRender: v } = u, y = n ? n.defaults : gu.defaults, b = fd(m, y.ease), x = fd(h, y.playbackEase), S = x ? mf(x) : null, C = !Z(b.ease), w = C ? b.ease : fd(m, S ? "linear" : y.ease), T = C ? b.settlingDuration : fd(p, y.duration), E = fd(f, y.delay), D = g || y.modifier, O = Z(_) && c >= 1e3 ? Hl.none : Z(_) ? y.composition : _, k = this._offset + (n ? n._offset : 0);
		C && (b.parent = this);
		let A = NaN, j = NaN, ee = 0, M = 0;
		for (let e = 0; e < c; e++) {
			let t = s[e], r = a || e, c = o || s, l = NaN, d = NaN;
			for (let e in u) if (Mu(e)) {
				let a = hd(t, e), o = od(t, e), s = Dd(e, t, a), f = u[e], p = xu(f);
				if (i && !p && (yf[0] = f, yf[1] = f, f = yf), p) {
					let e = f.length, t = !Su(f[0]);
					e === 2 && t ? (bf.to = f, vf[0] = bf, Cf = vf) : e > 2 && t ? (Cf = [], f.forEach((e, t) => {
						t ? t === 1 ? (yf[1] = e, Cf.push(yf)) : Cf.push(e) : yf[0] = e;
					})) : Cf = f;
				} else vf[0] = f, Cf = vf;
				let m = null, h = null, g = NaN, _ = 0, v = 0;
				for (let e = Cf.length; v < e; v++) {
					let i = Cf[v];
					Su(i) ? wf = i : (bf.to = i, wf = bf), gf.func = null, _f.func = null;
					let l = md(fd(wf.composition, O), t, r, c, null, null), u = Cu(l) ? l : Hl[l];
					!m && u !== Hl.none && (m = zd(t, s));
					let d = m ? m._tail : null, f = n && d && d.parent.parent === n ? d : h, p = md(wf.to, t, r, c, gf, f), y;
					Su(p) && !Z(p.to) ? (wf = p, y = p.to) : y = p;
					let b = md(wf.from, t, r, c, _f, f), x = wf.ease || w, S = md(x, t, r, c, null, f), C = Tu(S) || wu(S) ? S : x, A = !Z(C) && !Z(C.ease), j = A ? C.ease : C, te = A ? C.settlingDuration : md(fd(wf.duration, e > 1 ? md(T, t, r, c, null, f) / e : T), t, r, c, null, f), N = md(fd(wf.delay, v ? 0 : E), t, r, c, null, f), P = wf.modifier || D, ne = !Z(b), re = !Z(y), ie = xu(y), ae = ie || ne && re, oe = h ? _ : 0, se = h ? _ + N : N, ce = Wu(k + se, 12), F = Wu(k + oe, 12);
					!M && (ne || ie) && (M = 1);
					let le = h;
					if (u !== Hl.none) {
						let e = m._head;
						for (; e && e._absoluteStartTime <= ce;) if (e._isOverridden || (le = e), e = e._nextRep, e && e._absoluteStartTime >= ce) for (; e;) Vd(e), e = e._nextRep;
					}
					if (ae) {
						bd(ie ? md(y[0], t, r, c, _f, f) : b, Q), bd(ie ? md(y[1], t, r, c, gf, f) : y, $);
						let e = _d(t, s, a, hf);
						Q.t === X.NUMBER && (le ? le._valueType === X.UNIT && (Q.t = X.UNIT, Q.u = le._unit) : (bd(e, Sd), Sd.t === X.UNIT && (Q.t = X.UNIT, Q.u = Sd.u)));
					} else re ? bd(y, $) : h ? xd(h, $) : bd(n && le && le.parent.parent === n ? le._value : _d(t, s, a, hf), $), ne ? bd(b, Q) : h ? xd(h, Q) : bd(n && le && le.parent.parent === n ? le._value : _d(t, s, a, hf), Q);
					if (Q.o && (Q.n = vd(le ? le._toNumber : bd(_d(t, s, a, hf), Sd).n, Q.n, Q.o)), $.o && ($.n = vd(Q.n, $.n, $.o)), Q.t !== $.t) {
						if (Q.t === X.COMPLEX || $.t === X.COMPLEX) {
							let e = Q.t === X.COMPLEX ? Q : $, t = Q.t === X.COMPLEX ? $ : Q;
							t.t = X.COMPLEX, t.s = Ju(e.s), t.d = e.d.map(() => t.n);
						} else if (Q.t === X.UNIT || $.t === X.UNIT) {
							let e = Q.t === X.UNIT ? Q : $, t = Q.t === X.UNIT ? $ : Q;
							t.t = X.UNIT, t.u = e.u;
						} else if (Q.t === X.COLOR || $.t === X.COLOR) {
							let e = Q.t === X.COLOR ? Q : $, t = Q.t === X.COLOR ? $ : Q;
							t.t = X.COLOR, t.d = e.d.map(() => 0);
						}
					}
					if (Q.u !== $.u) {
						let e = $.u ? Q : $;
					...
					if ($.d && Q.d && $.d.length !== Q.d.length) {
						let e = Q.d.length > $.d.length ? Q : $, t = e === Q ? $ : Q;
						t.d = e.d.map((e, n) => Z(t.d[n]) ? 0 : t.d[n]), t.s = Ju(e.s);
					}
					let ue = Wu(+te || 1e-11, 12), de = hf[s];
					Eu(de) || (hf[s] = null);
					let fe = o ? o.set : null;
					_ = Wu(se + ue, 12);
					let pe = Q.d, me = $.d, he = $.s, ge = {
						parent: this,
						id: xf++,
						property: s,
						target: t,
						...
						_fromFunc: _f.func,
						_ease: mf(j),
						_fromNumbers: pe ? Ju(pe) : Zl,
						_toNumbers: me ? Ju(me) : Zl,
						_strings: he ? Ju(he) : Zl,
						_fromNumber: Q.n,
						_toNumber: $.n,
						_numbers: pe ? Ju(pe) : Zl,
						_number: Q.n,
						_unit: $.u,
						_modifier: P,
						_currentTime: 0,
						...
						_updateDuration: ue,
						_changeDuration: ue,
						_absoluteStartTime: ce,
						_absoluteUpdateStartTime: F,
						_absoluteEndTime: Wu(k + _, 12),
						_hasFromValue: ne || ie ? 1 : 0,
						_tweenType: a,
						_setter: fe,
						_valueType: $.t,
						_composition: u,
					...
					u !== Hl.none && Hd(ge, m);
					let _e = ge._valueType;
					if (_e === X.COMPLEX) ge._value = Cd(ge, 1, -1);
					else if (_e === X.UNIT) ge._value = `${P(ge._toNumber)}${ge._unit}`;
					else if (_e === X.COLOR) {
						let e = $.d;
						ge._value = `rgba(${Wu(e[0], 0)},${Wu(e[1], 0)},${Wu(e[2], 0)},${e[3]})`;
					} else ge._value = P(ge._toNumber);
					isNaN(g) && (g = ge._startTime), h = ge, ee++, Qu(this, ge);
				}
				(isNaN(j) || g < j) && (j = g), (isNaN(A) || _ > A) && (A = _), a === Bl.TRANSFORM && (l = ee - v, d = ee);
			}
			if (!isNaN(l)) {
				let e = 0;
				Xu(this, (t) => {
					e >= l && e < d && (t._renderTransforms = 1, t._composition === Hl.blend && Xu(Ad.animation, (e) => {
						e.id === t.id && (e._renderTransforms = 1);
					})), e++;
				});
			}
		}
		c || console.warn("No target found. Make sure the element you're trying to animate is accessible before creating your animation."), j ? (Xu(this, (e) => {
			e._startTime - e._delay || (e._delay -= j), e._startTime -= j;
		}), A -= j) : j = 0, A || (A = Jl, this.iterationCount = 0), this.targets = s, this.id = Z(d) ? Sf : d, this.duration = A === 1e-11 ? Jl : Ku((A + this._loopDelay) * this.iterationCount - this._loopDelay) || 1e-11, this.onRender = v || y.onRender, this._ease = S, this._delay = j, this.iterationDuration = A, !this._autoplay && M && this.onRender(this);
	}
	stretch(e) {
		let t = this.duration;
		if (t === qu(e)) return this;
		let n = e / t;
		return Xu(this, (e) => {
			e._updateDuration = qu(e._updateDuration * n), e._changeDuration = qu(e._changeDuration * n), e._currentTime *= n, e._delay *= n, e._startTime *= n, e._absoluteStartTime *= n, e._absoluteUpdateStartTime *= n, e._absoluteEndTime *= n;
		}), super.stretch(e);
	}
	refresh() {
		return Xu(this, (e) => {
			let t = e._toFunc, n = e._fromFunc;
			(t || n) && (n ? (bd(n(), Q), Q.u !== e._unit && e.target[Wl] && nf(e.target, Q, e._unit, !0), e._fromNumbers = Ju(Q.d), e._fromNumber = Q.n) : t && (bd(_d(e.target, e.property, e._tweenType), Sd), e._fromNumbers = Ju(Sd.d), e._fromNumber = Sd.n), t && (bd(t(), $), e._toNumbers = Ju($.d), e._strings = Ju($.s), e._toNumber = $.o ? vd(e._fromNumber, $.n, $.o) : $.n));
		}), this.duration === 1e-11 && this.restart(), this;
	}
	revert() {
		return super.revert(), Od(this);
	}
	then(e) {
		return super.then(e);
	}
}, Df = (e, t) => gu.editor ? gu.editor.addAnimation(e, t) : new Ef(e, t, null, 0, !1).init(), Of = (e, t) => {
	if (yu(t, "<")) {
	...
	if (n === 1e-11 && (n = 0), Z(t)) return n;
	if (Cu(+t)) return +t;
	let r = t, i = e ? e.labels : null, a = !Eu(i), o = Of(e, r), s = !Z(o), c = fu.exec(r);
	if (c) {
		let e = c[0], t = r.split(e), l = a && t[0] ? i[t[0]] : n;
		return vd(s ? o : a ? l : n, +t[1], e[0]);
	} else return s ? o : a ? Z(i[r]) ? n : i[r] : n;
};
//#endregion
//#region node_modules/animejs/dist/modules/timeline/timeline.js
function Af(e) {
	return Ku((e.iterationDuration + e._loopDelay) * e.iterationCount - e._loopDelay) || 1e-11;
}
function jf(e, t, n, r, i, a) {
	let o = Cu(e.duration) && e.duration <= 1e-11 ? n - Jl : n;
	t.composition && Td(t, o, 1, 1, Vl.AUTO);
	let s = r ? new Ef(r, e, t, o, !1, i, a) : new Xd(e, t, o);
	return t.composition && s.init(!0), Qu(t, s), Xu(t, (e) => {
		let n = e._offset + e._delay + e.duration;
		n > t.iterationDuration && (t.iterationDuration = n);
	}), t.duration = Af(t), t;
}
var Mf = 0, Nf = class extends Xd {
	constructor(e = {}) {
		super(e, null, 0), ++Mf, this.id = Z(e.id) ? Mf : e.id, this.duration = 0, this.labels = {};
		let t = e.defaults, n = gu.defaults;
		this.defaults = t ? Yu(t, n) : n, this.composition = fd(e.composition, !0), this.onRender = e.onRender || n.onRender;
		let r = fd(e.playbackEase, n.playbackEase);
		this._ease = r ? mf(r) : null, this.iterationDuration = 0;
	}
	add(e, t, n) {
		let r = Su(t), i = Su(e);
		if (r || i) {
			if (this._hasChildren = !0, r) {
				let r = t, i = gu.editor && gu.editor.addTimelineChild, a = n && n.type === "Stagger" && gu.editor, o = Tu(n) ? n : null;
				if (o || a) {
					let t = Qd(e), a = this.duration, s = this.iterationDuration, c = r.id, l = 0, u = t.length, d = i ? i(e, r, this.id, n, u) : null, f = o || gu.editor.resolveStagger(n.defaultValue);
					t.forEach((e) => {
						let n = { ...d || r };
						this.duration = a, this.iterationDuration = s, Z(c) || (n.id = c + "-" + l);
						let i = kf(this, f(e, l, t, null, this));
						jf(n, this, i, e, l, t), l++;
					});
				} else {
					let t = i ? i(e, r, this.id, n) : r, a = n && n.type ? n.defaultValue : n;
					jf(t, this, kf(this, a), e);
				}
			} else jf(e, this, kf(this, t));
			return this.composition && this.init(!0), this;
		}
	}
	sync(e, t) {
		if (Z(e) || e && Z(e.pause)) return this;
		e.pause();
		let n = +(e.effect ? e.effect.getTiming().duration : e.duration);
		!Z(e) && !Z(e.persist) && (e.persist = !0);
		let r = gu.editor, i = r && r.addTimelineChild;
		r && r.addTimelineSync && (t = r.addTimelineSync(e, t, this.id), r.addTimelineChild = null);
		let a = this.add(e, {
			currentTime: [0, n],
			duration: n,
			delay: 0,
		...
		return r && (r.addTimelineChild = i), a;
	}
	set(e, t, n) {
		return Z(t) ? this : (t.duration = Jl, t.composition = Hl.replace, this.add(e, t, n));
	}
	call(e, t) {
		return Z(e) || e && !Tu(e) ? this : (gu.editor && gu.editor.addTimelineCall && (t = gu.editor.addTimelineCall(e, t, this.id)), this.add({
			duration: 0,
			delay: 0,
			onComplete: () => e(this)
		}, t));
	...
	label(e, t) {
		return Z(e) || e && !wu(e) ? this : (gu.editor && gu.editor.addTimelineLabel && (t = gu.editor.addTimelineLabel(e, t, this.id)), this.labels[e] = kf(this, t), this);
	}
	remove(e, t) {
		return Gd(Qd(e), this, t), this;
	}
	stretch(e) {
		let t = this.duration;
		if (t === qu(e)) return this;
		let n = e / t, r = this.labels;
		Xu(this, (e) => e.stretch(e.duration * n));
		for (let e in r) r[e] *= n;
	...
	revert() {
		return super.revert(), Xu(this, (e) => e.revert, !0), Od(this);
	}
	then(e) {
		return super.then(e);
	}
}, Pf = (e) => gu.editor ? gu.editor.addTimeline(e) : new Nf(e).init(), Ff = (e) => e * Math.PI / 180, If = (e) => e * 180 / Math.PI, Lf = ad((e) => !!(e && !e.nodeType && (e.isObject3D || e.isMaterial || e.isTexture || e.isFog || e.isFogExp2 || e.isUniformNode || e.isColor || e.isVector2 || e.isVector3 || e.isVector4 || e.isAnimejsInstanceProxy))), Rf = 1 / 255, zf = {
	X: "x",
	Y: "y",
	Z: "z",
	W: "w"
...
function Uf(e, t, n, r, i, a, o) {
	if (t !== 0) {
		let n = Math.tan(Ff(t));
		e[4] += e[0] * n, e[5] += e[1] * n, e[6] += e[2] * n;
	}
	if (n !== 0) {
		let t = Math.tan(Ff(n));
		e[0] += e[4] * t, e[1] += e[5] * t, e[2] += e[6] * t;
	}
	if (r !== 0) {
		let t = Math.tan(Ff(r));
		e[0] += e[8] * t, e[1] += e[9] * t, e[2] += e[10] * t;
	}
	(i !== 0 || a !== 0 || o !== 0) && (e[12] += i - (e[0] * i + e[4] * a + e[8] * o), e[13] += a - (e[1] * i + e[5] * a + e[9] * o), e[14] += o - (e[2] * i + e[6] * a + e[10] * o));
}
function Wf(e) {
	return e ? `#${e.getHexString(Re)}` : null;
}
function Gf(e, t) {
	return e ? t === "x" || t === "y" ? !!(e.isVector2 || e.isVector3 || e.isVector4) : t === "z" ? !!(e.isVector3 || e.isVector4) : !!e.isVector4 : !1;
}
function Kf(e, t) {
	let n = e[t];
	if (n !== void 0) {
		if (n && n.isColor) return Hf.kind = 0, Hf.path = 0, Hf;
		if (n && n.isUniformNode) {
			let e = n.value;
			return e && e.isColor ? (Hf.kind = 0, Hf.path = Vf, Hf) : typeof e == "number" || typeof e == "boolean" ? (Hf.kind = 1, Hf.path = Vf, Hf) : null;
		}
		return typeof n == "number" || typeof n == "boolean" ? (Hf.kind = 1, Hf.path = 0, Hf) : null;
	}
	let r = e.uniforms, i = r && r[t];
	if (i) {
		let e = i.value;
		if (e && e.isColor) return Hf.kind = 0, Hf.path = Bf, Hf;
		if (typeof e == "number") return Hf.kind = 1, Hf.path = Bf, Hf;
	}
	let a = zf[t[t.length - 1]];
	if (a) {
		let n = t.slice(0, -1);
		if (Gf(e[n], a)) return Hf.kind = 2, Hf.path = 0, Hf.base = n, Hf.axis = a, Hf;
		let i = e[n];
		if (i && i.isUniformNode && Gf(i.value, a)) return Hf.kind = 2, Hf.path = Vf, Hf.base = n, Hf.axis = a, Hf;
		let o = r && r[n];
		if (o && Gf(o.value, a)) return Hf.kind = 2, Hf.path = Bf, Hf.base = n, Hf.axis = a, Hf;
	}
	return null;
}
function qf(e, t, n) {
...
function Yf(e, t, n, r) {
	if (r === void 0 && (r = 0), !e) return r;
	let i = Array.isArray(e) ? e[0] : e;
	return i ? qf(i, t, n) ?? r : r;
}
function Xf(e, t, n, r) {
	if (e) if (Array.isArray(e)) for (let i = 0, a = e.length; i < a; i++) Jf(e[i], t, n, r);
	else Jf(e, t, n, r);
}
function Zf(e, t, n) {
	if (!e) return null;
	let r = Array.isArray(e) ? e[0] : e;
	return Wf(r ? qf(r, t, n) : null);
}
function Qf(e, t, n, r) {
	if (!e) return;
	let i = n[0] * Rf, a = n[1] * Rf, o = n[2] * Rf;
	if (Array.isArray(e)) for (let n = 0, s = e.length; n < s; n++) {
		let s = qf(e[n], t, r);
		s && s.setRGB(i, a, o, Re);
	}
	else {
...
function $f(e, t, n, r) {
	if (!e) return 0;
	let i = Array.isArray(e) ? e[0] : e, a = i ? qf(i, t, r) : null;
	return a ? a[n] : 0;
}
function ep(e, t, n, r, i) {
	if (e) if (Array.isArray(e)) for (let a = 0, o = e.length; a < o; a++) {
		let o = qf(e[a], t, i);
		o && (o[n] = r);
	}
	else {
...
//#endregion
//#region node_modules/animejs/dist/modules/adapters/three/resolvers.js
var tp = (e) => e, np = (e) => e.material, rp = [
	{},
	{},
	{}
], ip = [
	...
	if (t.kind === 0) {
		...
		return t[e] || (t[e] = {
			get: (t) => Zf(n(t), e, o),
			set: (t, r, i) => Qf(n(t), e, i._numbers, o)
		});
	}
	if (t.kind === 1) {
		let t = i[o];
		return t[e] || (t[e] = {
			get: (t) => Yf(n(t), e, o),
			set: (t, r) => Xf(n(t), e, r, o)
		});
	}
	let s = t.base, c = t.axis, l = a[o];
	return l[e] || (l[e] = {
		get: (e) => $f(n(e), s, c, o),
		set: (e, t) => ep(n(e), s, c, t, o)
	});
};
Lf.registerPropertyResolver((e, t) => {
	let n = Kf(e, t);
	return !n || n.kind === 1 && n.path === 0 ? null : lp(t, n, tp, rp, ip, ap);
}), Lf.registerPropertyResolver((e, t) => {
	if (e[t] !== void 0) return null;
	let n = e.material;
	if (!n) return null;
	let r = Array.isArray(n) ? n[0] : n;
	if (!r) return null;
	let i = Kf(r, t);
	return i ? lp(t, i, np, op, sp, cp) : null;
});
var up = {
	rotation: 1,
	angle: 1
}, dp = {};
Lf.registerPropertyResolver((e, t) => !up[t] || typeof e[t] != "number" ? null : dp[t] || (dp[t] = {
	get: (e) => If(e[t]),
	set: (e, n) => {
		e[t] = Ff(n);
	}
...
var fp = {};
Lf.registerPropertyResolver((e, t) => {
	let n = zf[t[t.length - 1]];
	if (!n) return null;
	let r = t.slice(0, -1);
	if (!up[r]) return null;
	let i = e[r];
	return !i || !i.isEuler ? null : fp[t] || (fp[t] = {
		get: (e) => If(e[r][n]),
		set: (e, t) => {
			e[r][n] = Ff(t);
		}
...
//#endregion
//#region node_modules/animejs/dist/modules/adapters/three/uniform.js
var pp = Lf.registerTargetAdapter((e) => !!(e && e.isUniformNode));
pp.registerProperty("color", (e) => Wf(e.value), (e, t, n) => {
	let r = n._numbers;
	e.value.setRGB(r[0] * Rf, r[1] * Rf, r[2] * Rf, Re);
}, (e) => !!(e.value && e.value.isColor)), pp.registerProperty("x", (e) => e.value.x, (e, t) => {
	e.value.x = t;
}, (e) => Gf(e.value, "x")), pp.registerProperty("y", (e) => e.value.y, (e, t) => {
	e.value.y = t;
}, (e) => Gf(e.value, "y")), pp.registerProperty("z", (e) => e.value.z, (e, t) => {
	e.value.z = t;
}, (e) => Gf(e.value, "z")), pp.registerProperty("w", (e) => e.value.w, (e, t) => {
	e.value.w = t;
}, (e) => Gf(e.value, "w"));
//#endregion
//#region node_modules/animejs/dist/modules/adapters/three/object3d.js
var mp = (e) => e.isLight ? e : e.material, hp = Symbol("animejs.skewOrigin"), gp = Symbol("animejs.opacity");
function _p(e, t) {
	if (t === void 0) if (e.material) t = Yf(e.material, "opacity", 0, 1);
	else {
		let n = e[gp];
		t = n === void 0 ? 1 : n;
	}
	let n = e.scale;
	e.visible = !!(t && n.x && n.y && n.z);
}
function vp(e) {
	let t = e[hp];
	if (t) return t;
	...
	let n = e.updateMatrix;
	return e.updateMatrix = function() {
		n.call(this);
		let e = this[hp];
		(e.skewX !== 0 || e.skewY !== 0 || e.skewZ !== 0 || e.originX !== 0 || e.originY !== 0 || e.originZ !== 0) && Uf(this.matrix.elements, e.skewX, e.skewY, e.skewZ, e.originX, e.originY, e.originZ);
	}, t;
}
var yp = Lf.registerTargetAdapter((e) => e instanceof Tn);
yp.registerProperty("x", (e) => e.position.x, (e, t) => {
	e.position.x = t;
}), yp.registerProperty("y", (e) => e.position.y, (e, t) => {
	e.position.y = t;
}), yp.registerProperty("z", (e) => e.position.z, (e, t) => {
	e.position.z = t;
}), yp.registerProperty("rotateX", (e) => If(e.rotation.x), (e, t) => {
	e.rotation.x = Ff(t);
}), yp.registerProperty("rotateY", (e) => If(e.rotation.y), (e, t) => {
	e.rotation.y = Ff(t);
}), yp.registerProperty("rotateZ", (e) => If(e.rotation.z), (e, t) => {
	e.rotation.z = Ff(t);
}), yp.registerProperty("scaleX", (e) => e.scale.x, (e, t) => {
	e.scale.x = t, _p(e);
}), yp.registerProperty("scaleY", (e) => e.scale.y, (e, t) => {
	e.scale.y = t, _p(e);
}), yp.registerProperty("scaleZ", (e) => e.scale.z, (e, t) => {
	e.scale.z = t, _p(e);
}), yp.registerProperty("scale", (e) => e.scale.x, (e, t) => {
	e.scale.x = t, e.scale.y = t, e.scale.z = t, _p(e);
}), yp.registerProperty("visible", (e) => e.visible, (e, t) => {
	e.visible = !!t;
}), yp.registerProperty("opacity", (e) => {
	if (e.material) return Yf(e.material, "opacity", 0, 1);
	let t = e[gp];
	return t === void 0 ? 1 : t;
}, (e, t) => {
	e.material ? Xf(e.material, "opacity", t, 0) : e[gp] = t, _p(e, t);
}, (e) => !e.isLight), yp.registerProperty("color", (e) => Zf(mp(e), "color", 0), (e, t, n) => Qf(mp(e), "color", n._numbers, 0)), yp.registerProperty("groundColor", (e) => Zf(e, "groundColor", 0), (e, t, n) => Qf(e, "groundColor", n._numbers, 0), (e) => !!e.groundColor), yp.registerProperty("background", (e) => {
	let t = e.background;
	return t && t.isColor ? Wf(t) : "#000000";
}, (e, t, n) => {
	let r = e, i = r.background;
	(!i || !i.isColor) && (i = new q(), r.background = i);
	let a = n._numbers;
	i.setRGB(a[0] * Rf, a[1] * Rf, a[2] * Rf, Re);
}, (e) => !!e.isScene);
var bp = (e, t, n, r) => {
	yp.registerProperty(e, (e) => e[t](), (e, t) => {
		e[n](t);
	}, (e) => !!e[r]);
};
bp("volume", "getVolume", "setVolume", "setVolume"), bp("refDistance", "getRefDistance", "setRefDistance", "setRefDistance"), bp("rolloffFactor", "getRolloffFactor", "setRolloffFactor", "setRefDistance"), bp("maxDistance", "getMaxDistance", "setMaxDistance", "setRefDistance"), bp("focalLength", "getFocalLength", "setFocalLength", "setFocalLength");
var xp = (e, t) => {
	yp.registerProperty(e, (t) => t[e], (t, n) => {
		t[e] = n, t.updateProjectionMatrix();
	}, t);
}, Sp = (e) => !!e.isPerspectiveCamera, Cp = (e) => !!e.isOrthographicCamera;
xp("fov", Sp), xp("aspect", Sp), xp("left", Cp), xp("right", Cp), xp("top", Cp), xp("bottom", Cp);
var wp = (e, t) => {
	yp.registerProperty(e, (e) => {
		let n = e[hp];
		return n ? n[t] : 0;
	}, (e, n) => {
		vp(e)[t] = n;
...
wp("skewX", "skewX"), wp("skewY", "skewY"), wp("skewZ", "skewZ"), wp("transformOriginX", "originX"), wp("transformOriginY", "originY"), wp("transformOriginZ", "originZ"), yp.registerProperty("transformOrigin", (e) => {
	let t = e[hp];
	return t ? `${t.originX} ${t.originY} ${t.originZ}` : "0 0 0";
}, (e, t, n) => {
	let r = vp(e), i = n._numbers;
	r.originX = i[0], r.originY = i[1], r.originZ = i[2];
});
var Tp = (e) => !!e.isPerspectiveCamera || !!e.isOrthographicCamera;
xp("near", Tp), xp("far", Tp), xp("zoom", Tp);
//#endregion
//#region node_modules/animejs/dist/modules/adapters/three/instance.js
var Ep = (e) => !!(e._skewX || e._skewY || e._skewZ || e._originX || e._originY || e._originZ), Dp = 1, Op = 2, kp = 4, Ap = 8, jp = class {
	constructor(e, t) {
		this.isAnimejsInstanceProxy = !0, this.parent = e.mesh, this.id = t, this._position = new W(), this._rotation = new cn(0, 0, 0, "XYZ"), this._scale = new W(1, 1, 1), this._matrix = new Zt(), this._quat = new kt(), this._color = new q(), this._dirty = 0, this._skewX = 0, this._skewY = 0, this._skewZ = 0, this._originX = 0, this._originY = 0, this._originZ = 0, this._hasSkewOrigin = !1, this._dirtyList = e.dirtyList;
		let n = e.mesh;
		this._hasSetColor = "setColorAt" in n, this._hasSetVisible = "setVisibleAt" in n, this._hasGetVisible = "getVisibleAt" in n, n.getMatrixAt(t, this._matrix), this._matrix.elements[15] === 0 && this._matrix.identity(), this._matrix.decompose(this._position, this._quat, this._scale), this._rotation.setFromQuaternion(this._quat, "XYZ"), "getColorAt" in n && "instanceColor" in n && n.instanceColor && n.getColorAt(t, this._color);
	}
	_markDirty(e) {
		this._dirty === 0 && this._dirtyList.push(this), this._dirty |= e;
	}
	_flush() {
		let e = this._dirty;
		if (!e) return;
		let t = this._matrix, n = this._position;
		if (e === Dp && !this._hasSkewOrigin) {
			let e = t.elements;
			e[12] = n.x, e[13] = n.y, e[14] = n.z;
		} else {
			let r = this._quat;
			e & Op && r.setFromEuler(this._rotation), t.compose(n, r, this._scale), this._hasSkewOrigin && Uf(t.elements, this._skewX, this._skewY, this._skewZ, this._originX, this._originY, this._originZ);
		}
		this.parent.setMatrixAt(this.id, t), this._dirty = 0;
	}
	get x() {
		return this._position.x;
	}
	set x(e) {
		this._position.x = e, this._markDirty(Dp);
	}
	get y() {
		return this._position.y;
	}
	set y(e) {
		this._position.y = e, this._markDirty(Dp);
	}
	get z() {
		return this._position.z;
	}
	set z(e) {
		this._position.z = e, this._markDirty(Dp);
	}
	get rotateX() {
		return If(this._rotation.x);
	}
	set rotateX(e) {
		this._rotation.x = Ff(e), this._markDirty(Op);
	}
	get rotateY() {
		return If(this._rotation.y);
	}
	set rotateY(e) {
		this._rotation.y = Ff(e), this._markDirty(Op);
	}
	get rotateZ() {
		return If(this._rotation.z);
	}
	set rotateZ(e) {
		this._rotation.z = Ff(e), this._markDirty(Op);
	}
	get scaleX() {
		return this._scale.x;
	}
	set scaleX(e) {
		this._scale.x = e, this._markDirty(kp);
	}
	get scaleY() {
		return this._scale.y;
	}
	set scaleY(e) {
		this._scale.y = e, this._markDirty(kp);
	}
	get scaleZ() {
		return this._scale.z;
	}
	set scaleZ(e) {
		this._scale.z = e, this._markDirty(kp);
	}
	get scale() {
		return this._scale.x;
	}
	set scale(e) {
		let t = this._scale;
		t.x = e, t.y = e, t.z = e, this._markDirty(kp);
	}
	get skewX() {
		return this._skewX;
	}
	set skewX(e) {
		this._skewX = e, this._hasSkewOrigin = Ep(this), this._markDirty(Ap);
	}
	get skewY() {
		return this._skewY;
	}
	set skewY(e) {
		this._skewY = e, this._hasSkewOrigin = Ep(this), this._markDirty(Ap);
	}
	get skewZ() {
		return this._skewZ;
	}
	set skewZ(e) {
		this._skewZ = e, this._hasSkewOrigin = Ep(this), this._markDirty(Ap);
	}
	get transformOriginX() {
		return this._originX;
	}
	set transformOriginX(e) {
		this._originX = e, this._hasSkewOrigin = Ep(this), this._markDirty(Ap);
	}
	get transformOriginY() {
		return this._originY;
	}
	set transformOriginY(e) {
		this._originY = e, this._hasSkewOrigin = Ep(this), this._markDirty(Ap);
	}
	get transformOriginZ() {
		return this._originZ;
	}
	set transformOriginZ(e) {
		this._originZ = e, this._hasSkewOrigin = Ep(this), this._markDirty(Ap);
	}
	get opacity() {
		return Yf(this.parent.material, "opacity", 0, 1);
	}
	set opacity(e) {
		Xf(this.parent.material, "opacity", e, 0);
	}
	get visible() {
		return this._hasGetVisible ? this.parent.getVisibleAt(this.id) : !0;
	}
	set visible(e) {
		this._hasSetVisible && this.parent.setVisibleAt(this.id, e);
	}
}, Mp = Lf.registerTargetAdapter((e) => e instanceof jp);
Mp.registerProperty("color", (e) => Wf(e._color), (e, t, n) => {
	if (!e._hasSetColor) return;
	let r = n._numbers;
	e._color.setRGB(r[0] * Rf, r[1] * Rf, r[2] * Rf, Re);
	let i = e.parent;
	i.setColorAt(e.id, e._color), i.instanceColor && (i.instanceColor.needsUpdate = !0);
}), Mp.registerProperty("transformOrigin", (e) => `${e._originX} ${e._originY} ${e._originZ}`, (e, t, n) => {
	let r = n._numbers;
	e._originX = r[0], e._originY = r[1], e._originZ = r[2], e._hasSkewOrigin = Ep(e), e._markDirty(Ap);
});
//#endregion
//#region node_modules/three/examples/jsm/utils/BufferGeometryUtils.js
function Np(e, t = !1) {
	let n = e[0].index !== null, r = new Set(Object.keys(e[0].attributes)), i = new Set(Object.keys(e[0].morphAttributes)), a = {}, o = {}, s = e[0].morphTargetsRelative, c = new Or(), l = 0;
...
function Pp(e) {
	...
	let o = new t(a), s = new pr(o, n, r), c = 0;
...
//#endregion
//#region lib/cms/model.ts
var Fp = () => {
	let e = new ei(new Uint8Array([
		65,
		145,
		255
	]), 3, 1, k);
	return e.minFilter = e.magFilter = a, e.generateMipmaps = !1, e.needsUpdate = !0, e;
}, Ip = {
	red: "#f76b58",
	redDark: "#a84445",
	silver: "#b8c8d1",
...
function Lp(e, t, n, r, i, a) {
	let o = [], s = (e, t, n) => [
		...
		Math.cos(n) * t,
		Math.sin(n) * t
	], c = (e, t, n, r) => o.push(...e, ...t, ...n, ...e, ...n, ...r);
	for (let o = 0; o < a; o++) {
		let l = r + (i - r) * o / a, u = r + (i - r) * (o + 1) / a, d = -n / 2, f = n / 2;
		c(s(d, e, l), s(d, e, u), s(d, t, u), s(d, t, l)), c(s(f, e, l), s(f, t, l), s(f, t, u), s(f, e, u)), c(s(d, t, l), s(d, t, u), s(f, t, u), s(f, t, l)), c(s(d, e, l), s(f, e, l), s(f, e, u), s(d, e, u));
	}
	c(s(-n / 2, e, r), s(-n / 2, t, r), s(n / 2, t, r), s(n / 2, e, r)), c(s(-n / 2, e, i), s(n / 2, e, i), s(n / 2, t, i), s(-n / 2, t, i));
	let l = new Or();
	return l.setAttribute("position", new gr(o, 3)), l.computeVertexNormals(), l;
}
var Rp = class {
	constructor(e, t) {
		this.id = e, this.texture = t, this.batches = /* @__PURE__ */ new Map(), this.current = "frame", this.piece("frame");
	}
	piece(e, t = 0, n = 0, r = 0, i = 0) {
		this.current = e, this.batches.has(e) || this.batches.set(e, {
	...
	get geometry() {
		return this.batches.get(this.current).geometry;
	}
	get outlines() {
		return this.batches.get(this.current).outlines;
	}
	add(e, t, n = 0, r = 0, i = 0, a = 0, o = !0) {
		e.rotateX(a), e.translate(n, r, i);
		let s = e.index ? e.toNonIndexed() : e;
		s !== e && e.dispose(), s.deleteAttribute("uv"), this.geometry.has(t) || this.geometry.set(t, []), this.geometry.get(t).push(s), o && this.outlines.push(new Mi(s, 22));
	}
	box(e, t, n, r, i, a, o, s = 0, c = !0) {
		this.add(new Ei(r, i, a), o, e, t, n, s, c);
	}
	ring(e, t, n, r, i = 0, a = 72, o = !0) {
		this.add(Lp(e, t, n, 0, Math.PI * 2, a), r, i, 0, 0, 0, o);
	}
	arc(e, t, n, r, i, a, o = 0, s = 1) {
		this.add(Lp(e, t, n, r, i, s), a, o);
	}
	radialBox(e, t, n, r, i, a, o, s = !0) {
		this.box(e, Math.cos(n) * t, Math.sin(n) * t, r, i, a, o, n, s);
	}
	bolts(e, t, n, r = "silver", i = .024) {
		let a = new Di(i, i, .035, 6);
		a.rotateZ(Math.PI / 2);
		for (let i = 0; i < n; i++) {
			let o = i / n * Math.PI * 2;
			this.add(a.clone(), r, e, Math.cos(o) * t, Math.sin(o) * t, 0, !1);
		}
		a.dispose();
	}
	finish(e, t) {
		let n = new En();
		n.userData.layerId = this.id, n.position.x = e;
		let r = [], i = [], a = [];
		for (let e of this.batches.values()) {
			if (!e.geometry.size) continue;
			let t = new En(), o = new Yn();
			for (let t of e.geometry.values()) for (let e of t) e.computeBoundingBox(), o.union(e.boundingBox);
			let s = o.getCenter(new W());
			t.position.copy(s), t.userData.layerId = this.id;
			let c = [];
			for (let [t, n] of e.geometry) {
				let e = new q(Ip[t] || t);
				for (let t of n) {
					let n = t.getAttribute("position").count, r = new Float32Array(n * 3);
					for (let t = 0; t < n; t++) r[t * 3] = e.r, r[t * 3 + 1] = e.g, r[t * 3 + 2] = e.b;
					t.setAttribute("color", new pr(r, 3)), c.push(t);
				}
			}
			let l = Np(c);
			l.translate(-s.x, -s.y, -s.z);
			let u = r[0] ?? new Wi({
				color: "#ffffff",
				vertexColors: !0,
			...
			r.length || (u.userData.originalColor = u.color.clone(), r.push(u));
			let d = new Zr(l, u);
			d.userData.layerId = this.id, t.add(d), c.forEach((e) => e.dispose());
			let f = new li({
				color: "#10141b",
				transparent: !0,
				opacity: .85,
			...
			if (e.outlines.length) {
				let n = Np(e.outlines);
				n.translate(-s.x, -s.y, -s.z), t.add(new xi(n, f)), e.outlines.forEach((e) => e.dispose());
			}
			n.add(t), i.push(f), a.push({
				group: t,
				origin: s,
				offset: e.offset,
				turn: e.turn,
...
function zp(e) {
	...
	for (let e of [
		...
		for (let n = 0; n < 12; n++) {
			let r = n * Math.PI / 6 + Math.PI / 12, i = .014, a = r + Math.PI / 12;
			t.piece(`wheel-${e}-sector-${n}`, e * 1.3, Math.cos(a) * 2.35, Math.sin(a) * 2.35, n % 2 ? 9 : -9);
			for (let n = 0; n < 3; n++) {
				let a = 2.68 + n * .34;
				t.arc(a, a + .27, .94, r + i, r + Math.PI / 6 - i, n === 1 ? "redDark" : "red", e), t.arc(a + .28, a + .33, 1.13, r + .027, r + Math.PI / 6 - .027, "silver", e);
			}
			let o = r + Math.PI / 12;
			t.radialBox(e, 3.65, o, 1.08, .055, 1.72, "white");
			for (let n = -3; n <= 3; n++) t.radialBox(e + n * .135, 3.682, o, .018, .012, 1.61, "silverDark", !1);
			t.radialBox(e, 3.715, o, .25, .056, .18, "gold");
			for (let n of [-.44, .44]) t.radialBox(e + n, 3.735, o, .07, .085, 1.68, "silverDark");
			t.radialBox(e, 2.7, o, 1.03, .085, .2, "copper");
		}
		t.piece(`feet-${e}`, e * .75, -1.2, 0);
		for (let n of [2.5, 3.78]) t.box(e, -3.79, Math.sin(n) * 2.65, 1.04, .4, .65, "gold"), t.box(e, -3.99, Math.sin(n) * 2.65, 1.35, .13, .9, "silverDark");
	}
	return t.finish(0, -6.8);
}
function Bp(e) {
	let t = new Rp("solenoid", e);
	for (let e = 0; e < 12; e++) {
		let n = e * Math.PI / 6, r = n + Math.PI / 12;
		t.piece(`shell-${e}`, 0, Math.cos(r) * 2.2, Math.sin(r) * 2.2, e % 2 ? 8 : -8), t.arc(2.07, 2.48, 3.78, n + .008, n + Math.PI / 6 - .008, "silver", 0, 6), t.radialBox(0, 2.49, r, 3.5, .04, .04, "silverDark");
	}
	for (let e of [
		-1.92,
		-1.66,
		...
		1.66,
		1.92
	]) t.piece(`flange-${e}`, e * 1.25, 0, 0), t.ring(2.05, 2.53, .07, "silver", e), t.bolts(e + .042, 2.48, 36, "dark", .022);
	for (let e = 0; e < 32; e++) {
		let n = e / 32 * Math.PI * 2, r = Math.min(11, Math.floor(e / 32 * 12));
		t.piece(`shell-${r}`), t.radialBox(0, 2.45, n, 3.63, .04, .022, "silverDark", !1);
		for (let e of [-1.3, 1.3]) t.radialBox(e, 2.52, n, .21, .085, .15, "silver"), t.radialBox(e, 2.57, n, .08, .04, .05, "dark", !1);
	}
	t.piece("coil", 0, 0, 0);
	for (let e = 0; e < 20; e++) t.ring(2.08, 2.105, .035, "copper", -1.7 + e * .18, 72, !1);
	t.piece("services", 0, 2.6, 0), t.box(-.2, 2.68, 0, 1.1, .36, .75, "silverDark"), t.box(-.2, 2.91, 0, .85, .14, .62, "silver");
	for (let e of [
		-.23,
		0,
		.23
	]) t.box(-.2, 3.04, e, .1, .18, .1, "silver");
	for (let e of [-1.25, 1.25]) for (let n of [-1.25, 1.25]) t.box(e, -2.45, n, .48, .48, .38, "silverDark");
	return t.finish(0, -3);
}
function Vp(e) {
	let t = new Rp("hcal", e);
	for (let e = 0; e < 24; e++) {
		let n = e / 24 * Math.PI * 2;
		t.piece(`hcal-${e}`, 0, Math.cos(n + Math.PI / 24) * 2.2, Math.sin(n + Math.PI / 24) * 2.2, e % 2 ? 5 : -5), t.arc(1.42, 1.98, 3.12, n + .012, n + Math.PI / 12 - .012, e % 2 ? "gold" : "goldDark", 0, 3), t.arc(1.43, 1.95, .095, n + .018, n + Math.PI / 12 - .018, "gold", 1.61, 3);
		let r = n + Math.PI / 24;
		for (let e = -1.4; e <= 1.45; e += .19) t.radialBox(e, 1.99, r, .018, .017, .46, "goldDark", !1);
		t.radialBox(0, 2.025, r, 3.01, .075, .035, "silverDark");
		for (let e of [-1.43, 1.43]) t.radialBox(e, 2.07, r, .16, .1, .26, "gold");
	}
	return t.piece("inner-liner"), t.ring(1.4, 1.46, 3.18, "silverDark", 0, 72), t.piece("front-flange", -1.7, 0, 0), t.ring(1.4, 2.04, .08, "silver", -1.67, 48), t.bolts(1.68, 1.86, 48), t.finish(0, .6);
}
function Hp(e) {
	let t = new Rp("ecal", e);
	for (let e = 0; e < 32; e++) {
		let n = e / 32 * Math.PI * 2;
		t.piece(`ecal-${e}`, 0, Math.cos(n + Math.PI / 32) * 1.7, Math.sin(n + Math.PI / 32) * 1.7, e % 2 ? 6 : -6), t.arc(.97, 1.33, 2.6, n + .009, n + Math.PI / 16 - .009, e % 4 == 0 ? "white" : "green", 0, 2);
		let r = n + Math.PI / 32;
		for (let e = -1.1; e < 1.2; e += .19) t.radialBox(e, 1.335, r, .011, .019, .2, "dark", !1);
		e % 4 == 0 && t.radialBox(0, 1.38, r, 2.57, .1, .19, "white");
	}
	for (let e of [-1.36, 1.36]) t.piece(`ecal-frame-${e}`, e, 0, 0), t.ring(.95, 1.42, .12, "silver", e, 32), t.bolts(e + .07, 1.34, 32, "dark", .023);
	return t.finish(0, 4.3);
}
function Up(e) {
	let t = new Rp("tracker", e);
	for (let e of [
		.23,
		.36,
		.5,
		...
		t.piece(`tracker-shell-${e}`, (e - .5) * 5, (e - .5) * 2.5, 0), t.ring(e - .024, e, 2.5, "blueDark", 0, 48, !1);
		for (let n of [
			-1.34,
			-.7,
			0,
			.7,
			1.34
		]) t.ring(e - .035, e + .035, .055, "blue", n, 48);
		for (let n = 0; n < 24; n++) t.radialBox(0, e + .018, n / 24 * Math.PI * 2, 2.48, .025, .025, "silver", !1);
	}
	for (let e of [-1.4, 1.4]) t.piece(`tracker-end-${e}`, e * 1.6, 0, 0), t.ring(.12, .9, .1, "blue", e, 48), t.ring(.81, .92, .07, "silverDark", e + .06, 48), t.bolts(e + .11, .86, 32, "silver", .018);
	t.piece("tracker-shell-0.82");
	for (let e = 0; e < 16; e++) {
		let n = e / 16 * Math.PI * 2;
		t.radialBox(0, .87, n, 2.66, .045, .03, "blue"), t.radialBox(.35, .93, n, .35, .065, .075, "silverDark");
	}
	return t.finish(0, 7.7);
}
function Wp(e, t) {
	let n = new Rp("endcaps", t);
	for (let t = 0; t < 12; t++) {
		let r = t / 12 * Math.PI * 2 + Math.PI / 12;
		n.piece(`endcap-sector-${t}`, e * .25, Math.cos(r + Math.PI / 12) * 2.3, Math.sin(r + Math.PI / 12) * 2.3, t % 2 ? 7 : -7);
		for (let e = 0; e < 3; e++) n.arc(.6, 3.64, .18, r + .008, r + Math.PI / 6 - .008, "red", e * .31 - .31), n.arc(.72, 3.57, .055, r + .025, r + Math.PI / 6 - .025, "silver", e * .31 - .19);
		let i = r + Math.PI / 12;
		n.radialBox(.53, 2.16, i, .07, 2.65, .035, "gold");
		for (let e of [
			1.25,
			2.01,
			2.81,
			3.39
		]) n.arc(e, e + .032, .025, r + .025, r + Math.PI / 6 - .025, "silverDark", .515, 1), n.radialBox(.565, e, i, .07, .15, .08, "dark");
		n.radialBox(0, 3.65, i, .83, .11, .2, "gold");
	}
	n.piece("hub", e * .6, 0, 0), n.ring(.48, .69, 1.05, "silverDark", 0, 48), n.ring(.49, .62, .06, "silver", .56, 48), n.bolts(.6, .58, 18), n.piece("endcap-feet", 0, -1.2, 0);
	for (let e of [-1.9, 1.9]) n.box(0, -3.72, e, 1, .38, .63, "gold"), n.box(0, -3.94, e, 1.2, .14, .85, "silverDark");
	return n.finish(e * 2.75, e * (e > 0 ? 10.55 : 10));
}
function Gp(e, t) {
	let n = new Rp("support", t);
	for (let t of [-2.85, 2.85]) {
		n.piece(`pillar-${t}`, e * .6, 0, Math.sign(t) * 1.7);
		for (let e of [-.32, .32]) n.box(e, 0, t, .13, 7.85, .13, "support"), n.box(e, -3.97, t, .46, .12, .45, "silverDark");
		for (let e of [
			-3.6,
			-1.8,
			0,
			1.8,
			3.75
		]) n.box(0, e, t, .82, .1, .64, "support");
		for (let e = 0; e < 4; e++) {
			let r = -2.7 + e * 1.8, i = new Ei(.08, 2.05, .08);
			i.rotateX(e % 2 ? .33 : -.33), n.add(i, "support", 0, r, t);
		}
	}
	for (let t of [
		-3.75,
		...
		n.piece(`deck-${t}`, e * .6, Math.sign(t) * 1.7, 0), n.box(0, t, 0, .9, .13, 6.4, "support");
		for (let e = -8; e <= 8; e++) n.box(0, t + .08, e * .36, .8, .025, .022, "silverDark", 0, !1);
	}
	n.piece("deck-3.9");
	for (let e of [-.48, .48]) {
		n.box(e, 4.3, 0, .04, .05, 6.4, "support");
		for (let t = -5; t <= 5; t++) n.box(e, 4.08, t * .6, .04, .49, .04, "support");
	}
	n.piece("ladder", e * 1.2, 0, 2.5);
	for (let e = 0; e < 27; e++) n.box(.55, -3.6 + e * .28, 2.55, .1, .025, .47, "blue");
	return n.box(.55, 0, 2.33, .055, 7.6, .055, "blue"), n.box(.55, 0, 2.78, .055, 7.6, .055, "blue"), n.finish(e * 3.55, e * 12.1);
}
function Kp(e) {
	let t = new Rp("beam", e);
	t.ring(.034, .065, 28, "silver", 0, 12, !1);
	for (let e of [-13, 13]) t.ring(.06, .115, .22, "blue", e, 16);
	return t.finish(0, 0);
}
function qp() {
	let e = new En(), t = Fp(), n = [
	...
	return n.forEach((t) => e.add(t.group)), {
		root: e,
		parts: n,
		gradient: t
	};
...
//#endregion
//#region lib/cms/motion.ts
var Jp = 6e3;
function Yp(e) {
	let t = Pf({ autoplay: !1 });
	return e.parts.forEach((e, n) => {
		t.add(e.group, {
			x: [e.assembledX, e.explodedX],
			duration: 2800,
			ease: "inOut(3)"
		}, n * 65), e.pieces.forEach((e, r) => {
			let i = 3e3 + r % 12 * 44 + n * 18;
			t.add(e.group, {
				x: [e.origin.x, e.origin.x + e.offset.x],
				y: [e.origin.y, e.origin.y + e.offset.y],
				z: [e.origin.z, e.origin.z + e.offset.z],
				rotateX: [0, e.turn],
				duration: 1900,
				ease: "inOut(3)"
			}, i);
...
//#endregion
//#region lib/cms/viewer.ts
function Xp(t, n = {}) {
	if (!t || !t.appendChild) throw Error("CMS Detector needs a mounted HTML element.");
	let r = new pl({
		alpha: !0,
		antialias: !0,
		powerPreference: "high-performance"
	});
	r.setPixelRatio(Math.min(window.devicePixelRatio || 1, Math.max(1, n.maxPixelRatio ?? 1.75))), r.setClearColor(0, 0), r.outputColorSpace = Re, r.toneMapping = 0;
	let i = r.domElement;
	i.style.cssText = "display:block;width:100%;height:100%;touch-action:pan-y;outline:none;", i.setAttribute("role", "img"), i.setAttribute("aria-label", "Cel-shaded CMS detector. Main layers and individual sectors separate as the animation progresses."), t.appendChild(i);
	let a = new Pn(), o = new Ca(-15, 15, 9, -9, .1, 150), s = new W(0, .25, 0), c = new W(14, 9, 26).add(s);
	o.position.copy(c), o.lookAt(s);
	let l = new wl(o, i);
	l.target.copy(s), l.enableDamping = !0, l.dampingFactor = .08, l.enablePan = !1, l.enableZoom = !1, l.enabled = n.interactive !== !1, l.minPolarAngle = .15, l.maxPolarAngle = Math.PI * .85, l.mouseButtons = {
		LEFT: e.ROTATE,
		MIDDLE: e.DOLLY,
		RIGHT: e.ROTATE
	}, i.style.touchAction = "pan-y";
	let u = new Ea("#dbe6f5", .85);
	a.add(u);
	let d = new Ta("#fff7e6", 1.65);
	d.position.set(5, 12, 10), a.add(d);
	let f = new Ta("#aacbff", .35);
	f.position.set(-9, 3, -6), a.add(f);
	let p = qp();
	a.add(p.root);
	let m = Yp(p), h = new _i(new Or().setFromPoints([new W(-15, 0, 0), new W(15, 0, 0)]), new qi({
		color: "#809299",
		transparent: !0,
		opacity: .22,
		dashSize: .15,
	...
	h.computeLineDistances(), a.add(h);
	let g = window.matchMedia("(prefers-reduced-motion: reduce)"), _ = g.matches, v = { progress: Ot.clamp(n.initialProgress ?? 0, 0, 100) }, y = !1, b = 100, x = !1, S = !0, C = !1, w = n.blueprint ?? !1, T = null, E = null, D = null, O, k = 0, A = 0, j = 1, ee = 1, M = !0, te = p.parts.reduce((e, t) => e + t.pieces.length, 0), N = () => {
		let e = v.progress / 100, t = 9.5 + 5.6 * Math.min(1, e * 1.5), n = 5.7 + 2.4 * e, r = Math.max(n, t / ee);
		o.left = -r * ee, o.right = r * ee, o.top = r, o.bottom = -r, o.zoom = j, o.updateProjectionMatrix(), M = !0;
	}, P = () => {
		m.seek(v.progress / 100 * Jp), N(), t.dataset.cmsProgress = v.progress.toFixed(1), n.onProgress?.(v.progress);
	}, ne = () => {
		for (let e of p.parts) {
			let t = T === e.id, n = T !== null && !t;
			for (let r of e.materials) r.color.copy(r.userData.originalColor), r.vertexColors === w && (r.vertexColors = !w, r.needsUpdate = !0), w && r.color.set("#133248"), n && r.color.multiplyScalar(.32), r.emissive.set(t ? w ? "#368bab" : "#24313a" : "#000000"), r.emissiveIntensity = t ? .35 : 0;
			for (let t of e.edges) t.color.set(w ? "#b5e8ff" : "#10141b"), t.opacity = w ? n ? .16 : .72 : n ? .4 : .9;
		}
		t.dataset.cmsStyle = w ? "blueprint" : "cel", M = !0;
	}, re = (e) => {
		y = e, n.onPlayState?.(e);
	}, ie = () => {
		E?.cancel(), E = null, clearTimeout(O), re(!1);
	}, ae = (e, t = !1) => {
		if (x || !Number.isFinite(e)) return;
		ie();
		let n = Ot.clamp(e, 0, 100);
		t && !_ ? E = Df(v, {
			progress: n,
			duration: 280,
			ease: "out(3)",
		...
		if (!(x || C)) {
			...
			re(!0), E = Df(v, {
				progress: e,
				duration: Math.max(600, Math.abs(e - v.progress) * 45),
				ease: "linear",
				onUpdate: P,
				onComplete: () => {
					re(!1), E = null, n.loop && !_ && (O = setTimeout(() => oe(e === 100 ? 0 : 100), 1300));
				}
			}), (document.hidden || !S) && E.pause();
		}
	}, se = () => {
		D?.cancel(), j = 1, l.target.copy(s), N(), _ ? (o.position.copy(c), o.lookAt(s)) : D = Df(o, {
			x: c.x,
			y: c.y,
			z: c.z,
			duration: 800,
		...
		!e || !n || x || (ee = e / n, N(), r.setSize(e, n, !1));
	}, F = new ResizeObserver(ce);
	F.observe(t);
	let le = new IntersectionObserver((e) => {
		S = e[0]?.isIntersecting ?? !0, S && !document.hidden && !C ? (y && E?.resume(), de()) : (E?.pause(), fe());
	});
	le.observe(t);
	let ue = () => {
		if (k = 0, x || !S || document.hidden || C) return;
		let e = l.update();
		(M || e) && (r.render(a, o), M = !1), k = requestAnimationFrame(ue);
	};
	function de() {
		!k && !x && S && !document.hidden && !C && (k = requestAnimationFrame(ue));
	}
	function fe() {
		cancelAnimationFrame(k), k = 0;
	}
	let pe = () => {
		document.hidden ? (E?.pause(), fe()) : S && (y && E?.resume(), de());
	}, me = () => {
		_ = g.matches, _ && (ie(), D?.cancel());
	}, he = () => {
		!n.scrollTarget || A || (A = requestAnimationFrame(() => {
			if (A = 0, x) return;
			let e = n.scrollTarget.getBoundingClientRect(), t = n.scrollTarget.offsetHeight - window.innerHeight;
			t > 0 && e.bottom > 0 && e.top < window.innerHeight && ae(-e.top / t * 100, !0);
		}));
	}, ge = 0, _e = 0, ve = new U(), ye = new Wa(), be = (e) => {
		ge = e.clientX, _e = e.clientY, D?.cancel();
	}, xe = (e) => {
		T = e, ne(), n.onSelect?.(e);
	}, Se = (e) => {
		if (n.interactive === !1 || Math.hypot(e.clientX - ge, e.clientY - _e) > 5) return;
		let t = i.getBoundingClientRect();
		ve.set((e.clientX - t.left) / t.width * 2 - 1, -(e.clientY - t.top) / t.height * 2 + 1), ye.setFromCamera(ve, o);
		let r = ye.intersectObjects(p.root.children, !0).find((e) => e.object instanceof Zr);
		if (r) {
			let e = r.object.userData.layerId;
			xe(e === T ? null : e);
		}
	}, Ce = (e) => {
		e.preventDefault(), C = !0, ie(), fe(), n.onError?.("The 3D context was interrupted. Reload the viewer to restore it.");
	};
	return i.addEventListener("pointerdown", be), i.addEventListener("pointerup", Se), i.addEventListener("webglcontextlost", Ce), document.addEventListener("visibilitychange", pe), g.addEventListener("change", me), n.scrollTarget && window.addEventListener("scroll", he, { passive: !0 }), n.scrollTarget && he(), ne(), ce(), P(), de(), n.autoPlay && !_ && oe(100), {
		setProgress: ae,
		pause: ie,
		play: () => oe(v.progress >= 99.9 ? 0 : v.progress <= .1 ? 100 : b),
		explode: () => oe(100),
		assemble: () => oe(0),
		setBlueprint: (e) => {
			w = e, ne();
		...
		resetCamera: se,
		zoom: (e) => {
			Number.isFinite(e) && e > 0 && (j = Ot.clamp(j * e, .65, 2.2), N());
		},
		get progress() {
			return v.progress;
		},
		...
		destroy: () => {
			if (x) return;
			x = !0, ie(), D?.cancel(), m.cancel(), fe(), cancelAnimationFrame(A), F.disconnect(), le.disconnect(), l.dispose(), document.removeEventListener("visibilitychange", pe), g.removeEventListener("change", me), window.removeEventListener("scroll", he), i.removeEventListener("pointerdown", be), i.removeEventListener("pointerup", Se), i.removeEventListener("webglcontextlost", Ce);
			let e = /* @__PURE__ */ new Set(), n = /* @__PURE__ */ new Set();
			a.traverse((t) => {
				if (t instanceof Zr || t instanceof _i) {
					e.add(t.geometry);
					for (let e of Array.isArray(t.material) ? t.material : [t.material]) n.add(e);
				}
			}), e.forEach((e) => e.dispose()), n.forEach((e) => e.dispose()), p.gradient.dispose(), r.dispose(), r.forceContextLoss(), i.remove(), delete t.dataset.cmsProgress, delete t.dataset.cmsStyle;
		}
	};
}
//#endregion
export { Xp as createCMSDetector };
